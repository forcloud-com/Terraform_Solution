...
namespace aws.Opsworks
{
    ...
    [JsiiInterface(nativeType: typeof(IOpsworksPhpAppLayerConfig), fullyQualifiedName: "aws.opsworks.OpsworksPhpAppLayerConfig")]
    public interface IOpsworksPhpAppLayerConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.opsworks.OpsworksPhpAppLayerEbsVolume\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? EbsVolume
        {
            get
        ...
        /// <summary>AWS OpsWorks.</summary>
        [JsiiTypeProxy(nativeType: typeof(IOpsworksPhpAppLayerConfig), fullyQualifiedName: "aws.opsworks.OpsworksPhpAppLayerConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Opsworks.IOpsworksPhpAppLayerConfig
        {
