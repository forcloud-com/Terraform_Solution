...
namespace aws.Opsworks
{
    ...
    [JsiiInterface(nativeType: typeof(IOpsworksRailsAppLayerConfig), fullyQualifiedName: "aws.opsworks.OpsworksRailsAppLayerConfig")]
    public interface IOpsworksRailsAppLayerConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.opsworks.OpsworksRailsAppLayerEbsVolume\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? EbsVolume
        {
            get
        ...
        /// <summary>AWS OpsWorks.</summary>
        [JsiiTypeProxy(nativeType: typeof(IOpsworksRailsAppLayerConfig), fullyQualifiedName: "aws.opsworks.OpsworksRailsAppLayerConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Opsworks.IOpsworksRailsAppLayerConfig
        {
