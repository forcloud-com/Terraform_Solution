...
{
    /// <summary>Represents a {@link https://www.terraform.io/docs/providers/aws/r/opsworks_mysql_layer aws_opsworks_mysql_layer}.</summary>
    [JsiiClass(nativeType: typeof(aws.Opsworks.OpsworksMysqlLayer), fullyQualifiedName: "aws.opsworks.OpsworksMysqlLayer", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.opsworks.OpsworksMysqlLayerConfig\"}}]")]
    public class OpsworksMysqlLayer : HashiCorp.Cdktf.TerraformResource
    {
        /// <summary>Create a new {@link https://www.terraform.io/docs/providers/aws/r/opsworks_mysql_layer aws_opsworks_mysql_layer} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public OpsworksMysqlLayer(Constructs.Construct scope, string id, aws.Opsworks.IOpsworksMysqlLayerConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        protected OpsworksMysqlLayer(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected OpsworksMysqlLayer(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiMethod(name: "resetRootPassword")]
        public virtual void ResetRootPassword()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }

        [JsiiMethod(name: "resetRootPasswordOnAllInstances")]
        public virtual void ResetRootPasswordOnAllInstances()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        = GetStaticProperty<string>(typeof(aws.Opsworks.OpsworksMysqlLayer))!;
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolumeInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.opsworks.OpsworksMysqlLayerEbsVolume\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "rootPasswordInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? RootPasswordInput
        {
            get => GetInstanceProperty<string?>();
        }

        [JsiiOptional]
        [JsiiProperty(name: "rootPasswordOnAllInstancesInput", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktf.IResolvable\"}]}}", isOptional: true)]
        public virtual object? RootPasswordOnAllInstancesInput
        {
            get => GetInstanceProperty<object?>();
        }
        ...
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.opsworks.OpsworksMysqlLayerEbsVolume\"},\"kind\":\"array\"}}]}}")]
        ...
        [JsiiProperty(name: "rootPassword", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string RootPassword
        {
            get => GetInstanceProperty<string>()!;
            set => SetInstanceProperty(value);
        }

        [JsiiProperty(name: "rootPasswordOnAllInstances", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktf.IResolvable\"}]}}")]
        public virtual object RootPasswordOnAllInstances
        {
            get => GetInstanceProperty<object>()!;
            set => SetInstanceProperty(value);
        }
