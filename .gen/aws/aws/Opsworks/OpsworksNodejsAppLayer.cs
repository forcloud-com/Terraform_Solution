...
{
    /// <summary>Represents a {@link https://www.terraform.io/docs/providers/aws/r/opsworks_nodejs_app_layer aws_opsworks_nodejs_app_layer}.</summary>
    [JsiiClass(nativeType: typeof(aws.Opsworks.OpsworksNodejsAppLayer), fullyQualifiedName: "aws.opsworks.OpsworksNodejsAppLayer", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.opsworks.OpsworksNodejsAppLayerConfig\"}}]")]
    public class OpsworksNodejsAppLayer : HashiCorp.Cdktf.TerraformResource
    {
        /// <summary>Create a new {@link https://www.terraform.io/docs/providers/aws/r/opsworks_nodejs_app_layer aws_opsworks_nodejs_app_layer} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public OpsworksNodejsAppLayer(Constructs.Construct scope, string id, aws.Opsworks.IOpsworksNodejsAppLayerConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        protected OpsworksNodejsAppLayer(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected OpsworksNodejsAppLayer(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiMethod(name: "resetNodejsVersion")]
        public virtual void ResetNodejsVersion()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        = GetStaticProperty<string>(typeof(aws.Opsworks.OpsworksNodejsAppLayer))!;
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolumeInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.opsworks.OpsworksNodejsAppLayerEbsVolume\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "nodejsVersionInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? NodejsVersionInput
        {
            get => GetInstanceProperty<string?>();
        }
        ...
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.opsworks.OpsworksNodejsAppLayerEbsVolume\"},\"kind\":\"array\"}}]}}")]
        ...
        [JsiiProperty(name: "nodejsVersion", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string NodejsVersion
        {
            get => GetInstanceProperty<string>()!;
            set => SetInstanceProperty(value);
        }
