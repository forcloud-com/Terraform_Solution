...
namespace aws.Opsworks
{
    ...
    public class OpsworksGangliaLayerConfig : aws.Opsworks.IOpsworksGangliaLayerConfig
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.opsworks.OpsworksGangliaLayerEbsVolume\"},\"kind\":\"array\"}}]}}", isOptional: true)]
