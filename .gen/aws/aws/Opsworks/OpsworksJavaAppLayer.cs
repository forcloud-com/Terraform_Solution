...
{
    /// <summary>Represents a {@link https://www.terraform.io/docs/providers/aws/r/opsworks_java_app_layer aws_opsworks_java_app_layer}.</summary>
    [JsiiClass(nativeType: typeof(aws.Opsworks.OpsworksJavaAppLayer), fullyQualifiedName: "aws.opsworks.OpsworksJavaAppLayer", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.opsworks.OpsworksJavaAppLayerConfig\"}}]")]
    public class OpsworksJavaAppLayer : HashiCorp.Cdktf.TerraformResource
    {
        /// <summary>Create a new {@link https://www.terraform.io/docs/providers/aws/r/opsworks_java_app_layer aws_opsworks_java_app_layer} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public OpsworksJavaAppLayer(Constructs.Construct scope, string id, aws.Opsworks.IOpsworksJavaAppLayerConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        protected OpsworksJavaAppLayer(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected OpsworksJavaAppLayer(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiMethod(name: "resetAppServerVersion")]
        public virtual void ResetAppServerVersion()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        [JsiiMethod(name: "resetJvmType")]
        public virtual void ResetJvmType()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }

        [JsiiMethod(name: "resetJvmVersion")]
        public virtual void ResetJvmVersion()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        = GetStaticProperty<string>(typeof(aws.Opsworks.OpsworksJavaAppLayer))!;
        ...
        [JsiiOptional]
        [JsiiProperty(name: "appServerVersionInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? AppServerVersionInput
        {
            get => GetInstanceProperty<string?>();
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolumeInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.opsworks.OpsworksJavaAppLayerEbsVolume\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "jvmTypeInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? JvmTypeInput
        {
            get => GetInstanceProperty<string?>();
        }

        [JsiiOptional]
        [JsiiProperty(name: "jvmVersionInput", typeJson: "{\"primitive\":\"string\"}", isOptional: true)]
        public virtual string? JvmVersionInput
        {
            get => GetInstanceProperty<string?>();
        }
        ...
        [JsiiProperty(name: "appServerVersion", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string AppServerVersion
        {
            get => GetInstanceProperty<string>()!;
            set => SetInstanceProperty(value);
        }
        ...
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.opsworks.OpsworksJavaAppLayerEbsVolume\"},\"kind\":\"array\"}}]}}")]
        public virtual object EbsVolume
        {
            get => GetInstanceProperty<object>()!;
            set => SetInstanceProperty(value);
        }
        ...
        [JsiiProperty(name: "jvmType", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string JvmType
        {
            get => GetInstanceProperty<string>()!;
            set => SetInstanceProperty(value);
        }

        [JsiiProperty(name: "jvmVersion", typeJson: "{\"primitive\":\"string\"}")]
        public virtual string JvmVersion
        {
            get => GetInstanceProperty<string>()!;
            set => SetInstanceProperty(value);
        }
