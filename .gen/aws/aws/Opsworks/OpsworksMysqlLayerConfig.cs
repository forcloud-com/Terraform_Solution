...
namespace aws.Opsworks
{
    ...
    public class OpsworksMysqlLayerConfig : aws.Opsworks.IOpsworksMysqlLayerConfig
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.opsworks.OpsworksMysqlLayerEbsVolume\"},\"kind\":\"array\"}}]}}", isOptional: true)]
