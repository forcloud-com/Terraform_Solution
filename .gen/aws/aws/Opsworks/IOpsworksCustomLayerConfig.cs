...
namespace aws.Opsworks
{
    ...
    [JsiiInterface(nativeType: typeof(IOpsworksCustomLayerConfig), fullyQualifiedName: "aws.opsworks.OpsworksCustomLayerConfig")]
    public interface IOpsworksCustomLayerConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.opsworks.OpsworksCustomLayerEbsVolume\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? EbsVolume
        {
            get
        ...
        /// <summary>AWS OpsWorks.</summary>
        [JsiiTypeProxy(nativeType: typeof(IOpsworksCustomLayerConfig), fullyQualifiedName: "aws.opsworks.OpsworksCustomLayerConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Opsworks.IOpsworksCustomLayerConfig
        {
