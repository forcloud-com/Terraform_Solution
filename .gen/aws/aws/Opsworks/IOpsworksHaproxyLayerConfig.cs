...
namespace aws.Opsworks
{
    ...
    [JsiiInterface(nativeType: typeof(IOpsworksHaproxyLayerConfig), fullyQualifiedName: "aws.opsworks.OpsworksHaproxyLayerConfig")]
    public interface IOpsworksHaproxyLayerConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "ebsVolume", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.opsworks.OpsworksHaproxyLayerEbsVolume\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? EbsVolume
        {
            get
        ...
        /// <summary>AWS OpsWorks.</summary>
        [JsiiTypeProxy(nativeType: typeof(IOpsworksHaproxyLayerConfig), fullyQualifiedName: "aws.opsworks.OpsworksHaproxyLayerConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Opsworks.IOpsworksHaproxyLayerConfig
        {
