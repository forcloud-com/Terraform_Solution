...
namespace aws.Codecommit
{
    ...
    [JsiiInterface(nativeType: typeof(ICodecommitRepositoryConfig), fullyQualifiedName: "aws.codecommit.CodecommitRepositoryConfig")]
    public interface ICodecommitRepositoryConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS CodeCommit.</summary>
        [JsiiTypeProxy(nativeType: typeof(ICodecommitRepositoryConfig), fullyQualifiedName: "aws.codecommit.CodecommitRepositoryConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Codecommit.ICodecommitRepositoryConfig
        {
