...
namespace aws.Accessanalyzer
{
    ...
    [JsiiInterface(nativeType: typeof(IAccessanalyzerAnalyzerConfig), fullyQualifiedName: "aws.accessanalyzer.AccessanalyzerAnalyzerConfig")]
    public interface IAccessanalyzerAnalyzerConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>Access Analyzer Analyzer.</summary>
        [JsiiTypeProxy(nativeType: typeof(IAccessanalyzerAnalyzerConfig), fullyQualifiedName: "aws.accessanalyzer.AccessanalyzerAnalyzerConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Accessanalyzer.IAccessanalyzerAnalyzerConfig
        {
