...
namespace aws.Servicediscovery
{
    ...
    [JsiiInterface(nativeType: typeof(IServiceDiscoveryPrivateDnsNamespaceConfig), fullyQualifiedName: "aws.servicediscovery.ServiceDiscoveryPrivateDnsNamespaceConfig")]
    public interface IServiceDiscoveryPrivateDnsNamespaceConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Service Discovery.</summary>
        [JsiiTypeProxy(nativeType: typeof(IServiceDiscoveryPrivateDnsNamespaceConfig), fullyQualifiedName: "aws.servicediscovery.ServiceDiscoveryPrivateDnsNamespaceConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Servicediscovery.IServiceDiscoveryPrivateDnsNamespaceConfig
        {
