...
namespace aws.Batch
{
    ...
    [JsiiByValue(fqn: "aws.batch.DataAwsBatchComputeEnvironmentConfig")]
    public class DataAwsBatchComputeEnvironmentConfig : aws.Batch.IDataAwsBatchComputeEnvironmentConfig
    {
