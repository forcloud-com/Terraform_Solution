...
namespace aws.Batch
{
    ...
    public class BatchComputeEnvironmentComputeResourcesLaunchTemplateOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public BatchComputeEnvironmentComputeResourcesLaunchTemplateOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
