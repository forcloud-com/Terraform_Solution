...
namespace aws.Apigateway
{
    ...
    public class ApiGatewayMethodSettingsSettingsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public ApiGatewayMethodSettingsSettingsOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
