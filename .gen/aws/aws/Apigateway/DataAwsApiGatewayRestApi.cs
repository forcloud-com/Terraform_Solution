...
namespace aws.Apigateway
{
    ...
    public class DataAwsApiGatewayRestApi : HashiCorp.Cdktf.TerraformDataSource
    {
        ...
        [JsiiProperty(name: "endpointConfiguration", typeJson: "{\"fqn\":\"aws.apigateway.DataAwsApiGatewayRestApiEndpointConfigurationList\"}")]
        public virtual aws.Apigateway.DataAwsApiGatewayRestApiEndpointConfigurationList EndpointConfiguration
        {
            get => GetInstanceProperty<aws.Apigateway.DataAwsApiGatewayRestApiEndpointConfigurationList>()!;
        }
