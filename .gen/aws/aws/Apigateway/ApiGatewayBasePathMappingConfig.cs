...
namespace aws.Apigateway
{
    ...
    [JsiiByValue(fqn: "aws.apigateway.ApiGatewayBasePathMappingConfig")]
    public class ApiGatewayBasePathMappingConfig : aws.Apigateway.IApiGatewayBasePathMappingConfig
    {
