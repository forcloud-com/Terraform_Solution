...
namespace aws.Apigateway
{
    ...
    [JsiiInterface(nativeType: typeof(IDataAwsApiGatewayResourceConfig), fullyQualifiedName: "aws.apigateway.DataAwsApiGatewayResourceConfig")]
    public interface IDataAwsApiGatewayResourceConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>API Gateway.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDataAwsApiGatewayResourceConfig), fullyQualifiedName: "aws.apigateway.DataAwsApiGatewayResourceConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Apigateway.IDataAwsApiGatewayResourceConfig
        {
