...
{
    /// <summary>Represents a {@link https://www.terraform.io/docs/providers/aws/r/dx_hosted_private_virtual_interface aws_dx_hosted_private_virtual_interface}.</summary>
    [JsiiClass(nativeType: typeof(aws.Directconnect.DxHostedPrivateVirtualInterface), fullyQualifiedName: "aws.directconnect.DxHostedPrivateVirtualInterface", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.directconnect.DxHostedPrivateVirtualInterfaceConfig\"}}]")]
    public class DxHostedPrivateVirtualInterface : HashiCorp.Cdktf.TerraformResource
    {
        /// <summary>Create a new {@link https://www.terraform.io/docs/providers/aws/r/dx_hosted_private_virtual_interface aws_dx_hosted_private_virtual_interface} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public DxHostedPrivateVirtualInterface(Constructs.Construct scope, string id, aws.Directconnect.IDxHostedPrivateVirtualInterfaceConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        protected DxHostedPrivateVirtualInterface(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected DxHostedPrivateVirtualInterface(DeputyProps props): base(props)
        {
        }

        [JsiiMethod(name: "putTimeouts", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.directconnect.DxHostedPrivateVirtualInterfaceTimeouts\"}}]")]
        public virtual void PutTimeouts(aws.Directconnect.IDxHostedPrivateVirtualInterfaceTimeouts @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.Directconnect.IDxHostedPrivateVirtualInterfaceTimeouts)}, new object[]{@value});
        }
        ...
        = GetStaticProperty<string>(typeof(aws.Directconnect.DxHostedPrivateVirtualInterface))!;
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.directconnect.DxHostedPrivateVirtualInterfaceTimeoutsOutputReference\"}")]
        public virtual aws.Directconnect.DxHostedPrivateVirtualInterfaceTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<aws.Directconnect.DxHostedPrivateVirtualInterfaceTimeoutsOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"fqn\":\"aws.directconnect.DxHostedPrivateVirtualInterfaceTimeouts\"}", isOptional: true)]
        public virtual aws.Directconnect.IDxHostedPrivateVirtualInterfaceTimeouts? TimeoutsInput
        {
