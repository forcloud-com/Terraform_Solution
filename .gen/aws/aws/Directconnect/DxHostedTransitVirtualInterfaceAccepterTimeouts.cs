...
{
    [JsiiByValue(fqn: "aws.directconnect.DxHostedTransitVirtualInterfaceAccepterTimeouts")]
    public class DxHostedTransitVirtualInterfaceAccepterTimeouts : aws.Directconnect.IDxHostedTransitVirtualInterfaceAccepterTimeouts
    {
