...
{
    /// <summary>Represents a {@link https://www.terraform.io/docs/providers/aws/r/dx_public_virtual_interface aws_dx_public_virtual_interface}.</summary>
    [JsiiClass(nativeType: typeof(aws.Directconnect.DxPublicVirtualInterface), fullyQualifiedName: "aws.directconnect.DxPublicVirtualInterface", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.directconnect.DxPublicVirtualInterfaceConfig\"}}]")]
    public class DxPublicVirtualInterface : HashiCorp.Cdktf.TerraformResource
    {
        /// <summary>Create a new {@link https://www.terraform.io/docs/providers/aws/r/dx_public_virtual_interface aws_dx_public_virtual_interface} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public DxPublicVirtualInterface(Constructs.Construct scope, string id, aws.Directconnect.IDxPublicVirtualInterfaceConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiMethod(name: "putTimeouts", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.directconnect.DxPublicVirtualInterfaceTimeouts\"}}]")]
        public virtual void PutTimeouts(aws.Directconnect.IDxPublicVirtualInterfaceTimeouts @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.Directconnect.IDxPublicVirtualInterfaceTimeouts)}, new object[]{@value});
        }
        ...
        = GetStaticProperty<string>(typeof(aws.Directconnect.DxPublicVirtualInterface))!;
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.directconnect.DxPublicVirtualInterfaceTimeoutsOutputReference\"}")]
        public virtual aws.Directconnect.DxPublicVirtualInterfaceTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<aws.Directconnect.DxPublicVirtualInterfaceTimeoutsOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"fqn\":\"aws.directconnect.DxPublicVirtualInterfaceTimeouts\"}", isOptional: true)]
        public virtual aws.Directconnect.IDxPublicVirtualInterfaceTimeouts? TimeoutsInput
        {
            get => GetInstanceProperty<aws.Directconnect.IDxPublicVirtualInterfaceTimeouts?>();
        }
