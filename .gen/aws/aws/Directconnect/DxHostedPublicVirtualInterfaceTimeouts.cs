...
{
    [JsiiByValue(fqn: "aws.directconnect.DxHostedPublicVirtualInterfaceTimeouts")]
    public class DxHostedPublicVirtualInterfaceTimeouts : aws.Directconnect.IDxHostedPublicVirtualInterfaceTimeouts
    {
