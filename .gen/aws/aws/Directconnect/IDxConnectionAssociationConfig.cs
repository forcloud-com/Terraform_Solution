...
namespace aws.Directconnect
{
    ...
    [JsiiInterface(nativeType: typeof(IDxConnectionAssociationConfig), fullyQualifiedName: "aws.directconnect.DxConnectionAssociationConfig")]
    public interface IDxConnectionAssociationConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Direct Connect.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDxConnectionAssociationConfig), fullyQualifiedName: "aws.directconnect.DxConnectionAssociationConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Directconnect.IDxConnectionAssociationConfig
        {
