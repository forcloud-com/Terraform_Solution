...
namespace aws.Directconnect
{
    ...
    [JsiiInterface(nativeType: typeof(IDxHostedPublicVirtualInterfaceConfig), fullyQualifiedName: "aws.directconnect.DxHostedPublicVirtualInterfaceConfig")]
    public interface IDxHostedPublicVirtualInterfaceConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Directconnect.IDxHostedPublicVirtualInterfaceTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        /// <summary>AWS Direct Connect.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDxHostedPublicVirtualInterfaceConfig), fullyQualifiedName: "aws.directconnect.DxHostedPublicVirtualInterfaceConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Directconnect.IDxHostedPublicVirtualInterfaceConfig
        {
