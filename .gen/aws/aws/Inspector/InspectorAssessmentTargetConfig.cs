...
namespace aws.Inspector
{
    ...
    [JsiiByValue(fqn: "aws.inspector.InspectorAssessmentTargetConfig")]
    public class InspectorAssessmentTargetConfig : aws.Inspector.IInspectorAssessmentTargetConfig
    {
