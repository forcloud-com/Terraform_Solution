...
namespace aws.Cloudfront
{
    ...
    public class CloudfrontDistributionDefaultCacheBehaviorForwardedValuesCookiesOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public CloudfrontDistributionDefaultCacheBehaviorForwardedValuesCookiesOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
