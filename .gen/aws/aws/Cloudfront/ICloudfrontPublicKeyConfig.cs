...
namespace aws.Cloudfront
{
    ...
    [JsiiInterface(nativeType: typeof(ICloudfrontPublicKeyConfig), fullyQualifiedName: "aws.cloudfront.CloudfrontPublicKeyConfig")]
    public interface ICloudfrontPublicKeyConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS CloudFront.</summary>
        [JsiiTypeProxy(nativeType: typeof(ICloudfrontPublicKeyConfig), fullyQualifiedName: "aws.cloudfront.CloudfrontPublicKeyConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Cloudfront.ICloudfrontPublicKeyConfig
        {
