...
namespace aws.Cloudfront
{
    ...
    [JsiiByValue(fqn: "aws.cloudfront.CloudfrontDistributionLoggingConfig")]
    public class CloudfrontDistributionLoggingConfig : aws.Cloudfront.ICloudfrontDistributionLoggingConfig
    {
