...
namespace aws.Cloudfront
{
    ...
    public class CloudfrontDistributionOriginCustomOriginConfigOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public CloudfrontDistributionOriginCustomOriginConfigOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
