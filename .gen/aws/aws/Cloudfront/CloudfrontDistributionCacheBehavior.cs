...
namespace aws.Cloudfront
{
    ...
    [JsiiByValue(fqn: "aws.cloudfront.CloudfrontDistributionCacheBehavior")]
    public class CloudfrontDistributionCacheBehavior : aws.Cloudfront.ICloudfrontDistributionCacheBehavior
    {
