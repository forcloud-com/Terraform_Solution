...
namespace aws.Cloudfront
{
    ...
    public class CloudfrontDistributionViewerCertificateOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public CloudfrontDistributionViewerCertificateOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
