...
namespace aws.Rds
{
    ...
    [JsiiInterface(nativeType: typeof(IRdsClusterParameterGroupConfig), fullyQualifiedName: "aws.rds.RdsClusterParameterGroupConfig")]
    public interface IRdsClusterParameterGroupConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "parameter", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.rds.RdsClusterParameterGroupParameter\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? Parameter
        {
            get
        ...
        /// <summary>AWS Relational Database Service.</summary>
        [JsiiTypeProxy(nativeType: typeof(IRdsClusterParameterGroupConfig), fullyQualifiedName: "aws.rds.RdsClusterParameterGroupConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Rds.IRdsClusterParameterGroupConfig
        {
