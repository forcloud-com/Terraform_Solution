...
namespace aws.Rds
{
    ...
    [JsiiInterface(nativeType: typeof(IDataAwsDbEventCategoriesConfig), fullyQualifiedName: "aws.rds.DataAwsDbEventCategoriesConfig")]
    public interface IDataAwsDbEventCategoriesConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Relational Database Service.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDataAwsDbEventCategoriesConfig), fullyQualifiedName: "aws.rds.DataAwsDbEventCategoriesConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Rds.IDataAwsDbEventCategoriesConfig
        {
