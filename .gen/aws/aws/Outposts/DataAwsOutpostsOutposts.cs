...
{
    /// <summary>Represents a {@link https://www.terraform.io/docs/providers/aws/d/outposts_outposts aws_outposts_outposts}.</summary>
    [JsiiClass(nativeType: typeof(aws.Outposts.DataAwsOutpostsOutposts), fullyQualifiedName: "aws.outposts.DataAwsOutpostsOutposts", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"optional\":true,\"type\":{\"fqn\":\"aws.outposts.DataAwsOutpostsOutpostsConfig\"}}]")]
    public class DataAwsOutpostsOutposts : HashiCorp.Cdktf.TerraformDataSource
    {
        /// <summary>Create a new {@link https://www.terraform.io/docs/providers/aws/d/outposts_outposts aws_outposts_outposts} Data Source.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public DataAwsOutpostsOutposts(Constructs.Construct scope, string id, aws.Outposts.IDataAwsOutpostsOutpostsConfig? config = null): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        = GetStaticProperty<string>(typeof(aws.Outposts.DataAwsOutpostsOutposts))!;
