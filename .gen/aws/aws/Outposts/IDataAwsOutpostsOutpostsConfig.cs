...
namespace aws.Outposts
{
    ...
    [JsiiInterface(nativeType: typeof(IDataAwsOutpostsOutpostsConfig), fullyQualifiedName: "aws.outposts.DataAwsOutpostsOutpostsConfig")]
    public interface IDataAwsOutpostsOutpostsConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Outposts.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDataAwsOutpostsOutpostsConfig), fullyQualifiedName: "aws.outposts.DataAwsOutpostsOutpostsConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Outposts.IDataAwsOutpostsOutpostsConfig
        {
