...
namespace aws.Glue
{
    ...
    public class GlueSecurityConfigurationEncryptionConfigurationS3EncryptionOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public GlueSecurityConfigurationEncryptionConfigurationS3EncryptionOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
