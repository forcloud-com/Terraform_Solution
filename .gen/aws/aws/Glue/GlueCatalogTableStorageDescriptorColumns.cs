...
namespace aws.Glue
{
    ...
    [JsiiByValue(fqn: "aws.glue.GlueCatalogTableStorageDescriptorColumns")]
    public class GlueCatalogTableStorageDescriptorColumns : aws.Glue.IGlueCatalogTableStorageDescriptorColumns
    {
