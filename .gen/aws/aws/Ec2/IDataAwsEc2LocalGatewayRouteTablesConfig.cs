...
namespace aws.Ec2
{
    ...
    public interface IDataAwsEc2LocalGatewayRouteTablesConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "filter", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.ec2.DataAwsEc2LocalGatewayRouteTablesFilter\"},\"kind\":\"array\"}}]}}", isOptional: true)]
