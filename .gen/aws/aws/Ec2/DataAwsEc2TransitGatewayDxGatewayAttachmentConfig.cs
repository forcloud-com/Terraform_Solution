...
namespace aws.Ec2
{
    ...
    [JsiiByValue(fqn: "aws.ec2.DataAwsEc2TransitGatewayDxGatewayAttachmentConfig")]
    public class DataAwsEc2TransitGatewayDxGatewayAttachmentConfig : aws.Ec2.IDataAwsEc2TransitGatewayDxGatewayAttachmentConfig
    {
