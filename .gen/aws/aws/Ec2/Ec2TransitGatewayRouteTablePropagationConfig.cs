...
namespace aws.Ec2
{
    ...
    [JsiiByValue(fqn: "aws.ec2.Ec2TransitGatewayRouteTablePropagationConfig")]
    public class Ec2TransitGatewayRouteTablePropagationConfig : aws.Ec2.IEc2TransitGatewayRouteTablePropagationConfig
    {
