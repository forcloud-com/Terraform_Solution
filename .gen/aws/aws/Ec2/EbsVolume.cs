...
namespace aws.Ec2
{
    /// <summary>Represents a {@link https://www.terraform.io/docs/providers/aws/r/ebs_volume aws_ebs_volume}.</summary>
    [JsiiClass(nativeType: typeof(aws.Ec2.EbsVolume), fullyQualifiedName: "aws.ec2.EbsVolume", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.ec2.EbsVolumeConfig\"}}]")]
    public class EbsVolume : HashiCorp.Cdktf.TerraformResource
    {
        /// <summary>Create a new {@link https://www.terraform.io/docs/providers/aws/r/ebs_volume aws_ebs_volume} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public EbsVolume(Constructs.Construct scope, string id, aws.Ec2.IEbsVolumeConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        protected EbsVolume(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected EbsVolume(DeputyProps props): base(props)
        {
        }
        ...
        [JsiiMethod(name: "resetMultiAttachEnabled")]
        public virtual void ResetMultiAttachEnabled()
        {
            InvokeInstanceVoidMethod(new System.Type[]{}, new object[]{});
        }
        ...
        = GetStaticProperty<string>(typeof(aws.Ec2.EbsVolume))!;
        ...
        [JsiiOptional]
        [JsiiProperty(name: "multiAttachEnabledInput", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktf.IResolvable\"}]}}", isOptional: true)]
        public virtual object? MultiAttachEnabledInput
        {
            get => GetInstanceProperty<object?>();
        }
        ...
        [JsiiProperty(name: "multiAttachEnabled", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"boolean\"},{\"fqn\":\"cdktf.IResolvable\"}]}}")]
        public virtual object MultiAttachEnabled
        {
            get => GetInstanceProperty<object>()!;
            set => SetInstanceProperty(value);
        }
