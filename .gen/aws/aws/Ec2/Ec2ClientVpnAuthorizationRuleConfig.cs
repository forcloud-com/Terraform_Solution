...
namespace aws.Ec2
{
    ...
    [JsiiByValue(fqn: "aws.ec2.Ec2ClientVpnAuthorizationRuleConfig")]
    public class Ec2ClientVpnAuthorizationRuleConfig : aws.Ec2.IEc2ClientVpnAuthorizationRuleConfig
    {
