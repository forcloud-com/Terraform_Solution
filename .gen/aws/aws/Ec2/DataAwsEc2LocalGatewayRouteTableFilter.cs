...
namespace aws.Ec2
{
    ...
    [JsiiByValue(fqn: "aws.ec2.DataAwsEc2LocalGatewayRouteTableFilter")]
    public class DataAwsEc2LocalGatewayRouteTableFilter : aws.Ec2.IDataAwsEc2LocalGatewayRouteTableFilter
    {
