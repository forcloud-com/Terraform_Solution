...
namespace aws.Ec2
{
    [JsiiInterface(nativeType: typeof(ISpotFleetRequestLaunchSpecificationEbsBlockDevice), fullyQualifiedName: "aws.ec2.SpotFleetRequestLaunchSpecificationEbsBlockDevice")]
    public interface ISpotFleetRequestLaunchSpecificationEbsBlockDevice
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISpotFleetRequestLaunchSpecificationEbsBlockDevice), fullyQualifiedName: "aws.ec2.SpotFleetRequestLaunchSpecificationEbsBlockDevice")]
        internal sealed class _Proxy : DeputyBase, aws.Ec2.ISpotFleetRequestLaunchSpecificationEbsBlockDevice
        {
