...
namespace aws.Ec2
{
    [JsiiInterface(nativeType: typeof(IEc2ClientVpnEndpointAuthenticationOptions), fullyQualifiedName: "aws.ec2.Ec2ClientVpnEndpointAuthenticationOptions")]
    public interface IEc2ClientVpnEndpointAuthenticationOptions
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IEc2ClientVpnEndpointAuthenticationOptions), fullyQualifiedName: "aws.ec2.Ec2ClientVpnEndpointAuthenticationOptions")]
        internal sealed class _Proxy : DeputyBase, aws.Ec2.IEc2ClientVpnEndpointAuthenticationOptions
        {
