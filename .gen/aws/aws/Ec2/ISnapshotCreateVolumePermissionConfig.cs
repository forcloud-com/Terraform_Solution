...
namespace aws.Ec2
{
    ...
    [JsiiInterface(nativeType: typeof(ISnapshotCreateVolumePermissionConfig), fullyQualifiedName: "aws.ec2.SnapshotCreateVolumePermissionConfig")]
    public interface ISnapshotCreateVolumePermissionConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS EC2.</summary>
        [JsiiTypeProxy(nativeType: typeof(ISnapshotCreateVolumePermissionConfig), fullyQualifiedName: "aws.ec2.SnapshotCreateVolumePermissionConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Ec2.ISnapshotCreateVolumePermissionConfig
        {
