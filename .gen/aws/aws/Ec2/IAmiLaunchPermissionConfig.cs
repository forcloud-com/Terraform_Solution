...
namespace aws.Ec2
{
    ...
    [JsiiInterface(nativeType: typeof(IAmiLaunchPermissionConfig), fullyQualifiedName: "aws.ec2.AmiLaunchPermissionConfig")]
    public interface IAmiLaunchPermissionConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS EC2.</summary>
        [JsiiTypeProxy(nativeType: typeof(IAmiLaunchPermissionConfig), fullyQualifiedName: "aws.ec2.AmiLaunchPermissionConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Ec2.IAmiLaunchPermissionConfig
        {
