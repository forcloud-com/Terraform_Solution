...
namespace aws.Ec2
{
    ...
    public class LaunchTemplateMetadataOptionsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public LaunchTemplateMetadataOptionsOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
