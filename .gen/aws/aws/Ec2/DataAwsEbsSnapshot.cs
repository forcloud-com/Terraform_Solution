...
namespace aws.Ec2
{
    ...
    public class DataAwsEbsSnapshot : HashiCorp.Cdktf.TerraformDataSource
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "filterInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.ec2.DataAwsEbsSnapshotFilter\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiProperty(name: "filter", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.ec2.DataAwsEbsSnapshotFilter\"},\"kind\":\"array\"}}]}}")]
