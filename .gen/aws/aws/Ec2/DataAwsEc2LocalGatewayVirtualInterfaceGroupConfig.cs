...
namespace aws.Ec2
{
    ...
    [JsiiByValue(fqn: "aws.ec2.DataAwsEc2LocalGatewayVirtualInterfaceGroupConfig")]
    public class DataAwsEc2LocalGatewayVirtualInterfaceGroupConfig : aws.Ec2.IDataAwsEc2LocalGatewayVirtualInterfaceGroupConfig
    {
