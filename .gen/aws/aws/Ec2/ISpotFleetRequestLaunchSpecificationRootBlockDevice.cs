...
namespace aws.Ec2
{
    [JsiiInterface(nativeType: typeof(ISpotFleetRequestLaunchSpecificationRootBlockDevice), fullyQualifiedName: "aws.ec2.SpotFleetRequestLaunchSpecificationRootBlockDevice")]
    public interface ISpotFleetRequestLaunchSpecificationRootBlockDevice
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ISpotFleetRequestLaunchSpecificationRootBlockDevice), fullyQualifiedName: "aws.ec2.SpotFleetRequestLaunchSpecificationRootBlockDevice")]
        internal sealed class _Proxy : DeputyBase, aws.Ec2.ISpotFleetRequestLaunchSpecificationRootBlockDevice
        {
