...
namespace aws.Elasticbeanstalk
{
    ...
    public class ElasticBeanstalkEnvironment : HashiCorp.Cdktf.TerraformResource
    {
        ...
        [JsiiProperty(name: "allSettings", typeJson: "{\"fqn\":\"aws.elasticbeanstalk.ElasticBeanstalkEnvironmentAllSettingsList\"}")]
        public virtual aws.Elasticbeanstalk.ElasticBeanstalkEnvironmentAllSettingsList AllSettings
        {
            get => GetInstanceProperty<aws.Elasticbeanstalk.ElasticBeanstalkEnvironmentAllSettingsList>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "settingInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.elasticbeanstalk.ElasticBeanstalkEnvironmentSetting\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiProperty(name: "setting", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.elasticbeanstalk.ElasticBeanstalkEnvironmentSetting\"},\"kind\":\"array\"}}]}}")]
