...
namespace aws.Elasticbeanstalk
{
    ...
    public class ElasticBeanstalkApplicationAppversionLifecycleOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public ElasticBeanstalkApplicationAppversionLifecycleOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
