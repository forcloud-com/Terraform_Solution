...
namespace aws.Ecs
{
    ...
    [JsiiInterface(nativeType: typeof(IDataAwsEcsContainerDefinitionConfig), fullyQualifiedName: "aws.ecs.DataAwsEcsContainerDefinitionConfig")]
    public interface IDataAwsEcsContainerDefinitionConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS EC2 Container Service.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDataAwsEcsContainerDefinitionConfig), fullyQualifiedName: "aws.ecs.DataAwsEcsContainerDefinitionConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Ecs.IDataAwsEcsContainerDefinitionConfig
        {
