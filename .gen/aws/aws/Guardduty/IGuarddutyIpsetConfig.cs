...
namespace aws.Guardduty
{
    ...
    [JsiiInterface(nativeType: typeof(IGuarddutyIpsetConfig), fullyQualifiedName: "aws.guardduty.GuarddutyIpsetConfig")]
    public interface IGuarddutyIpsetConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS GuardDuty.</summary>
        [JsiiTypeProxy(nativeType: typeof(IGuarddutyIpsetConfig), fullyQualifiedName: "aws.guardduty.GuarddutyIpsetConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Guardduty.IGuarddutyIpsetConfig
        {
