...
namespace aws.S3
{
    ...
    public class DataAwsS3BucketObject : HashiCorp.Cdktf.TerraformDataSource
    {
        ...
        [JsiiMethod(name: "metadata", returnsJson: "{\"type\":{\"union\":{\"types\":[{\"primitive\":\"string\"},{\"fqn\":\"cdktf.IResolvable\"}]}}}", parametersJson: "[{\"name\":\"key\",\"type\":{\"primitive\":\"string\"}}]")]
        public virtual object Metadata(string key)
        {
