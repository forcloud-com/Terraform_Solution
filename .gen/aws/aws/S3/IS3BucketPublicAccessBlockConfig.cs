...
namespace aws.S3
{
    ...
    [JsiiInterface(nativeType: typeof(IS3BucketPublicAccessBlockConfig), fullyQualifiedName: "aws.s3.S3BucketPublicAccessBlockConfig")]
    public interface IS3BucketPublicAccessBlockConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Simple Storage Service.</summary>
        [JsiiTypeProxy(nativeType: typeof(IS3BucketPublicAccessBlockConfig), fullyQualifiedName: "aws.s3.S3BucketPublicAccessBlockConfig")]
        internal sealed class _Proxy : DeputyBase, aws.S3.IS3BucketPublicAccessBlockConfig
        {
