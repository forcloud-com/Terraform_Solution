...
namespace aws.S3
{
    [JsiiByValue(fqn: "aws.s3.S3BucketReplicationConfigurationRulesFilter")]
    public class S3BucketReplicationConfigurationRulesFilter : aws.S3.IS3BucketReplicationConfigurationRulesFilter
    {
