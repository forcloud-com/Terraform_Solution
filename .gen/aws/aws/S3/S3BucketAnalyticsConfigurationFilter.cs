...
namespace aws.S3
{
    [JsiiByValue(fqn: "aws.s3.S3BucketAnalyticsConfigurationFilter")]
    public class S3BucketAnalyticsConfigurationFilter : aws.S3.IS3BucketAnalyticsConfigurationFilter
    {
