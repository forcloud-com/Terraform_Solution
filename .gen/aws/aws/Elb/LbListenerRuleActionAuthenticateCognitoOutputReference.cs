...
namespace aws.Elb
{
    [JsiiClass(nativeType: typeof(aws.Elb.LbListenerRuleActionAuthenticateCognitoOutputReference), fullyQualifiedName: "aws.elb.LbListenerRuleActionAuthenticateCognitoOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class LbListenerRuleActionAuthenticateCognitoOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public LbListenerRuleActionAuthenticateCognitoOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.elb.LbListenerRuleActionAuthenticateCognito\"}", isOptional: true)]
        public virtual aws.Elb.ILbListenerRuleActionAuthenticateCognito? InternalValue
        {
