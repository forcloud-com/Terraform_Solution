...
namespace aws.Elb
{
    [JsiiInterface(nativeType: typeof(IAlbListenerRuleActionAuthenticateOidc), fullyQualifiedName: "aws.elb.AlbListenerRuleActionAuthenticateOidc")]
    public interface IAlbListenerRuleActionAuthenticateOidc
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IAlbListenerRuleActionAuthenticateOidc), fullyQualifiedName: "aws.elb.AlbListenerRuleActionAuthenticateOidc")]
        internal sealed class _Proxy : DeputyBase, aws.Elb.IAlbListenerRuleActionAuthenticateOidc
        {
