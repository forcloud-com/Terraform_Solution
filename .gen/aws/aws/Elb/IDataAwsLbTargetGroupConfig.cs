...
namespace aws.Elb
{
    ...
    [JsiiInterface(nativeType: typeof(IDataAwsLbTargetGroupConfig), fullyQualifiedName: "aws.elb.DataAwsLbTargetGroupConfig")]
    public interface IDataAwsLbTargetGroupConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Elastic Load Balancer.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDataAwsLbTargetGroupConfig), fullyQualifiedName: "aws.elb.DataAwsLbTargetGroupConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Elb.IDataAwsLbTargetGroupConfig
        {
