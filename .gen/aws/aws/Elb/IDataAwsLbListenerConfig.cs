...
namespace aws.Elb
{
    ...
    [JsiiInterface(nativeType: typeof(IDataAwsLbListenerConfig), fullyQualifiedName: "aws.elb.DataAwsLbListenerConfig")]
    public interface IDataAwsLbListenerConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Elastic Load Balancer.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDataAwsLbListenerConfig), fullyQualifiedName: "aws.elb.DataAwsLbListenerConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Elb.IDataAwsLbListenerConfig
        {
