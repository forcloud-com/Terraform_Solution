...
namespace aws.Elb
{
    ...
    public class LbListenerDefaultActionAuthenticateOidcOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public LbListenerDefaultActionAuthenticateOidcOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
