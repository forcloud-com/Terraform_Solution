...
namespace aws.Elb
{
    ...
    [JsiiByValue(fqn: "aws.elb.LbListenerRuleActionAuthenticateCognito")]
    public class LbListenerRuleActionAuthenticateCognito : aws.Elb.ILbListenerRuleActionAuthenticateCognito
    {
