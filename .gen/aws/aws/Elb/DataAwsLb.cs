...
namespace aws.Elb
{
    ...
    public class DataAwsLb : HashiCorp.Cdktf.TerraformDataSource
    {
        ...
        [JsiiProperty(name: "accessLogs", typeJson: "{\"fqn\":\"aws.elb.DataAwsLbAccessLogsList\"}")]
        public virtual aws.Elb.DataAwsLbAccessLogsList AccessLogs
        {
            get => GetInstanceProperty<aws.Elb.DataAwsLbAccessLogsList>()!;
        }
        ...
        [JsiiProperty(name: "subnetMapping", typeJson: "{\"fqn\":\"aws.elb.DataAwsLbSubnetMappingList\"}")]
        public virtual aws.Elb.DataAwsLbSubnetMappingList SubnetMapping
        {
            get => GetInstanceProperty<aws.Elb.DataAwsLbSubnetMappingList>()!;
        }
