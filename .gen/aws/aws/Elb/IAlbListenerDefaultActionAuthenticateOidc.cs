...
namespace aws.Elb
{
    [JsiiInterface(nativeType: typeof(IAlbListenerDefaultActionAuthenticateOidc), fullyQualifiedName: "aws.elb.AlbListenerDefaultActionAuthenticateOidc")]
    public interface IAlbListenerDefaultActionAuthenticateOidc
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IAlbListenerDefaultActionAuthenticateOidc), fullyQualifiedName: "aws.elb.AlbListenerDefaultActionAuthenticateOidc")]
        internal sealed class _Proxy : DeputyBase, aws.Elb.IAlbListenerDefaultActionAuthenticateOidc
        {
