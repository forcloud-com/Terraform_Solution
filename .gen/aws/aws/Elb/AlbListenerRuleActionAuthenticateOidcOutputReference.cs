...
namespace aws.Elb
{
    [JsiiClass(nativeType: typeof(aws.Elb.AlbListenerRuleActionAuthenticateOidcOutputReference), fullyQualifiedName: "aws.elb.AlbListenerRuleActionAuthenticateOidcOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class AlbListenerRuleActionAuthenticateOidcOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public AlbListenerRuleActionAuthenticateOidcOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.elb.AlbListenerRuleActionAuthenticateOidc\"}", isOptional: true)]
        public virtual aws.Elb.IAlbListenerRuleActionAuthenticateOidc? InternalValue
        {
