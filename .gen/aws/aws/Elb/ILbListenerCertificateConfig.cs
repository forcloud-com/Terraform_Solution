...
namespace aws.Elb
{
    ...
    [JsiiInterface(nativeType: typeof(ILbListenerCertificateConfig), fullyQualifiedName: "aws.elb.LbListenerCertificateConfig")]
    public interface ILbListenerCertificateConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Elastic Load Balancer.</summary>
        [JsiiTypeProxy(nativeType: typeof(ILbListenerCertificateConfig), fullyQualifiedName: "aws.elb.LbListenerCertificateConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Elb.ILbListenerCertificateConfig
        {
