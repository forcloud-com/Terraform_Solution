...
namespace aws.Elb
{
    ...
    [JsiiInterface(nativeType: typeof(IDataAwsAlbListenerConfig), fullyQualifiedName: "aws.elb.DataAwsAlbListenerConfig")]
    public interface IDataAwsAlbListenerConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Elastic Load Balancer.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDataAwsAlbListenerConfig), fullyQualifiedName: "aws.elb.DataAwsAlbListenerConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Elb.IDataAwsAlbListenerConfig
        {
