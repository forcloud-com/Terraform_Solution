...
namespace aws.Elb
{
    [JsiiInterface(nativeType: typeof(ILbListenerDefaultActionAuthenticateOidc), fullyQualifiedName: "aws.elb.LbListenerDefaultActionAuthenticateOidc")]
    public interface ILbListenerDefaultActionAuthenticateOidc
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ILbListenerDefaultActionAuthenticateOidc), fullyQualifiedName: "aws.elb.LbListenerDefaultActionAuthenticateOidc")]
        internal sealed class _Proxy : DeputyBase, aws.Elb.ILbListenerDefaultActionAuthenticateOidc
        {
