...
namespace aws.Elb
{
    ...
    public class LbListenerRuleActionFixedResponseOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public LbListenerRuleActionFixedResponseOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
