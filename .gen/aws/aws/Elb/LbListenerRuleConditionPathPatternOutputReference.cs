...
namespace aws.Elb
{
    ...
    public class LbListenerRuleConditionPathPatternOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public LbListenerRuleConditionPathPatternOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
