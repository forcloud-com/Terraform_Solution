...
namespace aws.Elb
{
    ...
    public class DataAwsLbListener : HashiCorp.Cdktf.TerraformDataSource
    {
        ...
        [JsiiProperty(name: "defaultAction", typeJson: "{\"fqn\":\"aws.elb.DataAwsLbListenerDefaultActionList\"}")]
        public virtual aws.Elb.DataAwsLbListenerDefaultActionList DefaultAction
        {
            get => GetInstanceProperty<aws.Elb.DataAwsLbListenerDefaultActionList>()!;
        }
