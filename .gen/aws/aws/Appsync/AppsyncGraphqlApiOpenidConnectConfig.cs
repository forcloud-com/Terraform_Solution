...
namespace aws.Appsync
{
    ...
    [JsiiByValue(fqn: "aws.appsync.AppsyncGraphqlApiOpenidConnectConfig")]
    public class AppsyncGraphqlApiOpenidConnectConfig : aws.Appsync.IAppsyncGraphqlApiOpenidConnectConfig
    {
