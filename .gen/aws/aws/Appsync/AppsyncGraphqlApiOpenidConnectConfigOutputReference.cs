...
{
    [JsiiClass(nativeType: typeof(aws.Appsync.AppsyncGraphqlApiOpenidConnectConfigOutputReference), fullyQualifiedName: "aws.appsync.AppsyncGraphqlApiOpenidConnectConfigOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class AppsyncGraphqlApiOpenidConnectConfigOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public AppsyncGraphqlApiOpenidConnectConfigOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.appsync.AppsyncGraphqlApiOpenidConnectConfig\"}", isOptional: true)]
        public virtual aws.Appsync.IAppsyncGraphqlApiOpenidConnectConfig? InternalValue
        {
