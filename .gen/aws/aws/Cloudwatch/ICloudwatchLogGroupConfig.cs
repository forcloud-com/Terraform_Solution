...
namespace aws.Cloudwatch
{
    ...
    [JsiiInterface(nativeType: typeof(ICloudwatchLogGroupConfig), fullyQualifiedName: "aws.cloudwatch.CloudwatchLogGroupConfig")]
    public interface ICloudwatchLogGroupConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS CloudWatch.</summary>
        [JsiiTypeProxy(nativeType: typeof(ICloudwatchLogGroupConfig), fullyQualifiedName: "aws.cloudwatch.CloudwatchLogGroupConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Cloudwatch.ICloudwatchLogGroupConfig
        {
