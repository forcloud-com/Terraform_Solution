...
{
    [JsiiInterface(nativeType: typeof(ICloudwatchMetricAlarmMetricQueryMetric), fullyQualifiedName: "aws.cloudwatch.CloudwatchMetricAlarmMetricQueryMetric")]
    public interface ICloudwatchMetricAlarmMetricQueryMetric
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(ICloudwatchMetricAlarmMetricQueryMetric), fullyQualifiedName: "aws.cloudwatch.CloudwatchMetricAlarmMetricQueryMetric")]
        internal sealed class _Proxy : DeputyBase, aws.Cloudwatch.ICloudwatchMetricAlarmMetricQueryMetric
        {
