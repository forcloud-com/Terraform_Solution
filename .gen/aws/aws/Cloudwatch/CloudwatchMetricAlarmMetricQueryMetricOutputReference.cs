...
namespace aws.Cloudwatch
{
    ...
    public class CloudwatchMetricAlarmMetricQueryMetricOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public CloudwatchMetricAlarmMetricQueryMetricOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
