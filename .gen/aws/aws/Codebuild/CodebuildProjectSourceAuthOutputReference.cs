...
namespace aws.Codebuild
{
    ...
    public class CodebuildProjectSourceAuthOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public CodebuildProjectSourceAuthOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
