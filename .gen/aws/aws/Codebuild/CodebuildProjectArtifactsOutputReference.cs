...
namespace aws.Codebuild
{
    ...
    public class CodebuildProjectArtifactsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public CodebuildProjectArtifactsOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
