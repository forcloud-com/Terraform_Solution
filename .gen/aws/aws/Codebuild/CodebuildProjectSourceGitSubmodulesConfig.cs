...
namespace aws.Codebuild
{
    ...
    [JsiiByValue(fqn: "aws.codebuild.CodebuildProjectSourceGitSubmodulesConfig")]
    public class CodebuildProjectSourceGitSubmodulesConfig : aws.Codebuild.ICodebuildProjectSourceGitSubmodulesConfig
    {
