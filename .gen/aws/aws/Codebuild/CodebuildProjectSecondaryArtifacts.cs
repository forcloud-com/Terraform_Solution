...
namespace aws.Codebuild
{
    ...
    [JsiiByValue(fqn: "aws.codebuild.CodebuildProjectSecondaryArtifacts")]
    public class CodebuildProjectSecondaryArtifacts : aws.Codebuild.ICodebuildProjectSecondaryArtifacts
    {
