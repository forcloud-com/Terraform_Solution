...
namespace aws.Kms
{
    ...
    [JsiiInterface(nativeType: typeof(IKmsCiphertextConfig), fullyQualifiedName: "aws.kms.KmsCiphertextConfig")]
    public interface IKmsCiphertextConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Key Management Service.</summary>
        [JsiiTypeProxy(nativeType: typeof(IKmsCiphertextConfig), fullyQualifiedName: "aws.kms.KmsCiphertextConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Kms.IKmsCiphertextConfig
        {
