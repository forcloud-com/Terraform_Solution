...
namespace aws.Kms
{
    ...
    [JsiiInterface(nativeType: typeof(IKmsAliasConfig), fullyQualifiedName: "aws.kms.KmsAliasConfig")]
    public interface IKmsAliasConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Key Management Service.</summary>
        [JsiiTypeProxy(nativeType: typeof(IKmsAliasConfig), fullyQualifiedName: "aws.kms.KmsAliasConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Kms.IKmsAliasConfig
        {
