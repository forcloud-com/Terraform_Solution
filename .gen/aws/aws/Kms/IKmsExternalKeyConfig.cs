...
namespace aws.Kms
{
    ...
    [JsiiInterface(nativeType: typeof(IKmsExternalKeyConfig), fullyQualifiedName: "aws.kms.KmsExternalKeyConfig")]
    public interface IKmsExternalKeyConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Key Management Service.</summary>
        [JsiiTypeProxy(nativeType: typeof(IKmsExternalKeyConfig), fullyQualifiedName: "aws.kms.KmsExternalKeyConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Kms.IKmsExternalKeyConfig
        {
