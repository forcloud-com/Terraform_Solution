...
namespace aws.Wafregional
{
    ...
    public class WafregionalIpset : HashiCorp.Cdktf.TerraformResource
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ipSetDescriptorInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.wafregional.WafregionalIpsetIpSetDescriptor\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiProperty(name: "ipSetDescriptor", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.wafregional.WafregionalIpsetIpSetDescriptor\"},\"kind\":\"array\"}}]}}")]
        public virtual object IpSetDescriptor
        {
            get => GetInstanceProperty<object>()!;
