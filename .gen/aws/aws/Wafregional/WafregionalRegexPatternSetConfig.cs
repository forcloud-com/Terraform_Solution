...
namespace aws.Wafregional
{
    ...
    [JsiiByValue(fqn: "aws.wafregional.WafregionalRegexPatternSetConfig")]
    public class WafregionalRegexPatternSetConfig : aws.Wafregional.IWafregionalRegexPatternSetConfig
    {
