...
namespace aws.Wafregional
{
    ...
    [JsiiByValue(fqn: "aws.wafregional.WafregionalByteMatchSetByteMatchTuple")]
    public class WafregionalByteMatchSetByteMatchTuple : aws.Wafregional.IWafregionalByteMatchSetByteMatchTuple
    {
