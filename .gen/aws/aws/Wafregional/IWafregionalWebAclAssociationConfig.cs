...
namespace aws.Wafregional
{
    ...
    [JsiiInterface(nativeType: typeof(IWafregionalWebAclAssociationConfig), fullyQualifiedName: "aws.wafregional.WafregionalWebAclAssociationConfig")]
    public interface IWafregionalWebAclAssociationConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS WAF Regional.</summary>
        [JsiiTypeProxy(nativeType: typeof(IWafregionalWebAclAssociationConfig), fullyQualifiedName: "aws.wafregional.WafregionalWebAclAssociationConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Wafregional.IWafregionalWebAclAssociationConfig
        {
