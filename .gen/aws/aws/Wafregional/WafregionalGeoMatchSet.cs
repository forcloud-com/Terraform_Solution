...
namespace aws.Wafregional
{
    ...
    public class WafregionalGeoMatchSet : HashiCorp.Cdktf.TerraformResource
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "geoMatchConstraintInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.wafregional.WafregionalGeoMatchSetGeoMatchConstraint\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiProperty(name: "geoMatchConstraint", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.wafregional.WafregionalGeoMatchSetGeoMatchConstraint\"},\"kind\":\"array\"}}]}}")]
        public virtual object GeoMatchConstraint
        {
            get => GetInstanceProperty<object>()!;
