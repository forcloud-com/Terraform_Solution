...
namespace aws.Vpc
{
    ...
    [JsiiInterface(nativeType: typeof(IDataAwsNatGatewayConfig), fullyQualifiedName: "aws.vpc.DataAwsNatGatewayConfig")]
    public interface IDataAwsNatGatewayConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "filter", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.vpc.DataAwsNatGatewayFilter\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        /// <summary>AWS VPC.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDataAwsNatGatewayConfig), fullyQualifiedName: "aws.vpc.DataAwsNatGatewayConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Vpc.IDataAwsNatGatewayConfig
        {
