...
namespace aws.Vpc
{
    ...
    public class DataAwsRouteTable : HashiCorp.Cdktf.TerraformDataSource
    {
        ...
        [JsiiProperty(name: "associations", typeJson: "{\"fqn\":\"aws.vpc.DataAwsRouteTableAssociationsList\"}")]
        public virtual aws.Vpc.DataAwsRouteTableAssociationsList Associations
        {
            get => GetInstanceProperty<aws.Vpc.DataAwsRouteTableAssociationsList>()!;
        }
        ...
        [JsiiProperty(name: "routes", typeJson: "{\"fqn\":\"aws.vpc.DataAwsRouteTableRoutesList\"}")]
        public virtual aws.Vpc.DataAwsRouteTableRoutesList Routes
        {
            get => GetInstanceProperty<aws.Vpc.DataAwsRouteTableRoutesList>()!;
        }

        [JsiiOptional]
        [JsiiProperty(name: "filterInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.vpc.DataAwsRouteTableFilter\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiProperty(name: "filter", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.vpc.DataAwsRouteTableFilter\"},\"kind\":\"array\"}}]}}")]
