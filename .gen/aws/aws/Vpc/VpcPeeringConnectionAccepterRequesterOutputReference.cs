...
namespace aws.Vpc
{
    [JsiiClass(nativeType: typeof(aws.Vpc.VpcPeeringConnectionAccepterRequesterOutputReference), fullyQualifiedName: "aws.vpc.VpcPeeringConnectionAccepterRequesterOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class VpcPeeringConnectionAccepterRequesterOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public VpcPeeringConnectionAccepterRequesterOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.vpc.VpcPeeringConnectionAccepterRequester\"}", isOptional: true)]
        public virtual aws.Vpc.IVpcPeeringConnectionAccepterRequester? InternalValue
        {
