...
namespace aws.Vpc
{
    ...
    public class DefaultSecurityGroup : HashiCorp.Cdktf.TerraformResource
    {
        ...
        [JsiiMethod(name: "putTimeouts", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.vpc.DefaultSecurityGroupTimeouts\"}}]")]
        public virtual void PutTimeouts(aws.Vpc.IDefaultSecurityGroupTimeouts @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.Vpc.IDefaultSecurityGroupTimeouts)}, new object[]{@value});
        }
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.vpc.DefaultSecurityGroupTimeoutsOutputReference\"}")]
        public virtual aws.Vpc.DefaultSecurityGroupTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<aws.Vpc.DefaultSecurityGroupTimeoutsOutputReference>()!;
        }

        [JsiiOptional]
        [JsiiProperty(name: "egressInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.vpc.DefaultSecurityGroupEgress\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ingressInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.vpc.DefaultSecurityGroupIngress\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"fqn\":\"aws.vpc.DefaultSecurityGroupTimeouts\"}", isOptional: true)]
        public virtual aws.Vpc.IDefaultSecurityGroupTimeouts? TimeoutsInput
        {
            get => GetInstanceProperty<aws.Vpc.IDefaultSecurityGroupTimeouts?>();
        }
        ...
        [JsiiProperty(name: "egress", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.vpc.DefaultSecurityGroupEgress\"},\"kind\":\"array\"}}]}}")]
        ...
        [JsiiProperty(name: "ingress", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.vpc.DefaultSecurityGroupIngress\"},\"kind\":\"array\"}}]}}")]
