...
namespace aws.Vpc
{
    [JsiiClass(nativeType: typeof(aws.Vpc.VpcPeeringConnectionAccepterAccepterOutputReference), fullyQualifiedName: "aws.vpc.VpcPeeringConnectionAccepterAccepterOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class VpcPeeringConnectionAccepterAccepterOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        /// <param name="terraformResource">The parent resource.</param>
        /// <param name="terraformAttribute">The attribute on the parent resource this class is referencing.</param>
        public VpcPeeringConnectionAccepterAccepterOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.vpc.VpcPeeringConnectionAccepterAccepter\"}", isOptional: true)]
        public virtual aws.Vpc.IVpcPeeringConnectionAccepterAccepter? InternalValue
        {
