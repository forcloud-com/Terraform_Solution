...
namespace aws.Vpc
{
    ...
    [JsiiInterface(nativeType: typeof(IDataAwsVpcEndpointConfig), fullyQualifiedName: "aws.vpc.DataAwsVpcEndpointConfig")]
    public interface IDataAwsVpcEndpointConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS VPC.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDataAwsVpcEndpointConfig), fullyQualifiedName: "aws.vpc.DataAwsVpcEndpointConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Vpc.IDataAwsVpcEndpointConfig
        {
