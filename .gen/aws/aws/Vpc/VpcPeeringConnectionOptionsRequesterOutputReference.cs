...
namespace aws.Vpc
{
    ...
    public class VpcPeeringConnectionOptionsRequesterOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public VpcPeeringConnectionOptionsRequesterOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
