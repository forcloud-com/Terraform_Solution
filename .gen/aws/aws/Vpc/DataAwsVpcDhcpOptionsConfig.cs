...
namespace aws.Vpc
{
    ...
    [JsiiByValue(fqn: "aws.vpc.DataAwsVpcDhcpOptionsConfig")]
    public class DataAwsVpcDhcpOptionsConfig : aws.Vpc.IDataAwsVpcDhcpOptionsConfig
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "filter", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.vpc.DataAwsVpcDhcpOptionsFilter\"},\"kind\":\"array\"}}]}}", isOptional: true)]
