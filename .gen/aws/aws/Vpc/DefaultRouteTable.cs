...
namespace aws.Vpc
{
    ...
    public class DefaultRouteTable : HashiCorp.Cdktf.TerraformResource
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "routeInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.vpc.DefaultRouteTableRoute\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiProperty(name: "route", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.vpc.DefaultRouteTableRoute\"},\"kind\":\"array\"}}]}}")]
        public virtual object Route
        {
            get => GetInstanceProperty<object>()!;
            set => SetInstanceProperty(value);
        }
