...
namespace aws.Vpc
{
    ...
    [JsiiInterface(nativeType: typeof(IDataAwsSubnetIdsConfig), fullyQualifiedName: "aws.vpc.DataAwsSubnetIdsConfig")]
    public interface IDataAwsSubnetIdsConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS VPC.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDataAwsSubnetIdsConfig), fullyQualifiedName: "aws.vpc.DataAwsSubnetIdsConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Vpc.IDataAwsSubnetIdsConfig
        {
