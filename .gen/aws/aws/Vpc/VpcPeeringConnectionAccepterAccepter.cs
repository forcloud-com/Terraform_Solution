...
namespace aws.Vpc
{
    [JsiiByValue(fqn: "aws.vpc.VpcPeeringConnectionAccepterAccepter")]
    public class VpcPeeringConnectionAccepterAccepter : aws.Vpc.IVpcPeeringConnectionAccepterAccepter
    {
