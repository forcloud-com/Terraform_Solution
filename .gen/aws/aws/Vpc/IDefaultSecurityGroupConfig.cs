...
namespace aws.Vpc
{
    ...
    [JsiiInterface(nativeType: typeof(IDefaultSecurityGroupConfig), fullyQualifiedName: "aws.vpc.DefaultSecurityGroupConfig")]
    public interface IDefaultSecurityGroupConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        [JsiiProperty(name: "egress", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.vpc.DefaultSecurityGroupEgress\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiProperty(name: "ingress", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.vpc.DefaultSecurityGroupIngress\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        object? Ingress
        {
            get
        ...
        /// <remarks>
        /// Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/default_security_group#timeouts DefaultSecurityGroup#timeouts}
        /// </remarks>
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.vpc.DefaultSecurityGroupTimeouts\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Vpc.IDefaultSecurityGroupTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        /// <summary>AWS VPC.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDefaultSecurityGroupConfig), fullyQualifiedName: "aws.vpc.DefaultSecurityGroupConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Vpc.IDefaultSecurityGroupConfig
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.vpc.DefaultSecurityGroupTimeouts\"}", isOptional: true)]
            public aws.Vpc.IDefaultSecurityGroupTimeouts? Timeouts
            {
