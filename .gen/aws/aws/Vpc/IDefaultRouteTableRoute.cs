...
namespace aws.Vpc
{
    [JsiiInterface(nativeType: typeof(IDefaultRouteTableRoute), fullyQualifiedName: "aws.vpc.DefaultRouteTableRoute")]
    public interface IDefaultRouteTableRoute
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IDefaultRouteTableRoute), fullyQualifiedName: "aws.vpc.DefaultRouteTableRoute")]
        internal sealed class _Proxy : DeputyBase, aws.Vpc.IDefaultRouteTableRoute
        {
