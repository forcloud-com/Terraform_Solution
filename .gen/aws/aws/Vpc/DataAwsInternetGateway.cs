...
namespace aws.Vpc
{
    ...
    public class DataAwsInternetGateway : HashiCorp.Cdktf.TerraformDataSource
    {
        ...
        [JsiiProperty(name: "attachments", typeJson: "{\"fqn\":\"aws.vpc.DataAwsInternetGatewayAttachmentsList\"}")]
        public virtual aws.Vpc.DataAwsInternetGatewayAttachmentsList Attachments
        {
            get => GetInstanceProperty<aws.Vpc.DataAwsInternetGatewayAttachmentsList>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "filterInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.vpc.DataAwsInternetGatewayFilter\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        [JsiiProperty(name: "filter", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.vpc.DataAwsInternetGatewayFilter\"},\"kind\":\"array\"}}]}}")]
