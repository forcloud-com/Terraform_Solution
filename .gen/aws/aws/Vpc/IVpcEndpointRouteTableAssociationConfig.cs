...
namespace aws.Vpc
{
    ...
    [JsiiInterface(nativeType: typeof(IVpcEndpointRouteTableAssociationConfig), fullyQualifiedName: "aws.vpc.VpcEndpointRouteTableAssociationConfig")]
    public interface IVpcEndpointRouteTableAssociationConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS VPC.</summary>
        [JsiiTypeProxy(nativeType: typeof(IVpcEndpointRouteTableAssociationConfig), fullyQualifiedName: "aws.vpc.VpcEndpointRouteTableAssociationConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Vpc.IVpcEndpointRouteTableAssociationConfig
        {
