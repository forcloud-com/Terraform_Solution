...
namespace aws.Vpc
{
    ...
    [JsiiByValue(fqn: "aws.vpc.DataAwsNetworkAclsConfig")]
    public class DataAwsNetworkAclsConfig : aws.Vpc.IDataAwsNetworkAclsConfig
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "filter", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.vpc.DataAwsNetworkAclsFilter\"},\"kind\":\"array\"}}]}}", isOptional: true)]
