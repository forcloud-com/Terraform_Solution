...
namespace aws.Vpc
{
    ...
    [JsiiInterface(nativeType: typeof(IVpcEndpointConfig), fullyQualifiedName: "aws.vpc.VpcEndpointConfig")]
    public interface IVpcEndpointConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// </remarks>
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.vpc.VpcEndpointTimeouts\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Vpc.IVpcEndpointTimeouts? Timeouts
        {
            get
            {
                return null;
        ...
        /// <summary>AWS VPC.</summary>
        [JsiiTypeProxy(nativeType: typeof(IVpcEndpointConfig), fullyQualifiedName: "aws.vpc.VpcEndpointConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Vpc.IVpcEndpointConfig
        {
