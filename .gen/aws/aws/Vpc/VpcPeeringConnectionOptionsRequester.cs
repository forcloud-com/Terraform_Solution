...
namespace aws.Vpc
{
    [JsiiByValue(fqn: "aws.vpc.VpcPeeringConnectionOptionsRequester")]
    public class VpcPeeringConnectionOptionsRequester : aws.Vpc.IVpcPeeringConnectionOptionsRequester
    {
