...
namespace aws.Vpc
{
    ...
    [JsiiInterface(nativeType: typeof(INetworkInterfaceAttachmentAConfig), fullyQualifiedName: "aws.vpc.NetworkInterfaceAttachmentAConfig")]
    public interface INetworkInterfaceAttachmentAConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS VPC.</summary>
        [JsiiTypeProxy(nativeType: typeof(INetworkInterfaceAttachmentAConfig), fullyQualifiedName: "aws.vpc.NetworkInterfaceAttachmentAConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Vpc.INetworkInterfaceAttachmentAConfig
        {
