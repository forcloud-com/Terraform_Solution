...
namespace aws.Iam
{
    ...
    [JsiiInterface(nativeType: typeof(IIamInstanceProfileConfig), fullyQualifiedName: "aws.iam.IamInstanceProfileConfig")]
    public interface IIamInstanceProfileConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Identity and Access Management.</summary>
        [JsiiTypeProxy(nativeType: typeof(IIamInstanceProfileConfig), fullyQualifiedName: "aws.iam.IamInstanceProfileConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Iam.IIamInstanceProfileConfig
        {
