...
namespace aws.Iam
{
    ...
    [JsiiByValue(fqn: "aws.iam.DataAwsIamPolicyDocumentStatementNotPrincipals")]
    public class DataAwsIamPolicyDocumentStatementNotPrincipals : aws.Iam.IDataAwsIamPolicyDocumentStatementNotPrincipals
    {
