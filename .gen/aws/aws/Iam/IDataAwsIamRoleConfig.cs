...
namespace aws.Iam
{
    ...
    [JsiiInterface(nativeType: typeof(IDataAwsIamRoleConfig), fullyQualifiedName: "aws.iam.DataAwsIamRoleConfig")]
    public interface IDataAwsIamRoleConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Identity and Access Management.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDataAwsIamRoleConfig), fullyQualifiedName: "aws.iam.DataAwsIamRoleConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Iam.IDataAwsIamRoleConfig
        {
