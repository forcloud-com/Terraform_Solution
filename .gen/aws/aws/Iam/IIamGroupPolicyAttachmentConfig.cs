...
namespace aws.Iam
{
    ...
    [JsiiInterface(nativeType: typeof(IIamGroupPolicyAttachmentConfig), fullyQualifiedName: "aws.iam.IamGroupPolicyAttachmentConfig")]
    public interface IIamGroupPolicyAttachmentConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Identity and Access Management.</summary>
        [JsiiTypeProxy(nativeType: typeof(IIamGroupPolicyAttachmentConfig), fullyQualifiedName: "aws.iam.IamGroupPolicyAttachmentConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Iam.IIamGroupPolicyAttachmentConfig
        {
