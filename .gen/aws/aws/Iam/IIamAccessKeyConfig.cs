...
namespace aws.Iam
{
    ...
    [JsiiInterface(nativeType: typeof(IIamAccessKeyConfig), fullyQualifiedName: "aws.iam.IamAccessKeyConfig")]
    public interface IIamAccessKeyConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Identity and Access Management.</summary>
        [JsiiTypeProxy(nativeType: typeof(IIamAccessKeyConfig), fullyQualifiedName: "aws.iam.IamAccessKeyConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Iam.IIamAccessKeyConfig
        {
