...
namespace aws.Elasticache
{
    ...
    public class ElasticacheCluster : HashiCorp.Cdktf.TerraformResource
    {
        ...
        [JsiiProperty(name: "cacheNodes", typeJson: "{\"fqn\":\"aws.elasticache.ElasticacheClusterCacheNodesList\"}")]
        public virtual aws.Elasticache.ElasticacheClusterCacheNodesList CacheNodes
        {
            get => GetInstanceProperty<aws.Elasticache.ElasticacheClusterCacheNodesList>()!;
        }
