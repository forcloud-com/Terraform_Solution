...
namespace aws.Elasticache
{
    ...
    [JsiiByValue(fqn: "aws.elasticache.ElasticacheSecurityGroupConfig")]
    public class ElasticacheSecurityGroupConfig : aws.Elasticache.IElasticacheSecurityGroupConfig
    {
