...
{
    /// <summary>Represents a {@link https://www.terraform.io/docs/providers/aws/d/elasticache_cluster aws_elasticache_cluster}.</summary>
    [JsiiClass(nativeType: typeof(aws.Elasticache.DataAwsElasticacheCluster), fullyQualifiedName: "aws.elasticache.DataAwsElasticacheCluster", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.elasticache.DataAwsElasticacheClusterConfig\"}}]")]
    public class DataAwsElasticacheCluster : HashiCorp.Cdktf.TerraformDataSource
    {
        /// <summary>Create a new {@link https://www.terraform.io/docs/providers/aws/d/elasticache_cluster aws_elasticache_cluster} Data Source.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public DataAwsElasticacheCluster(Constructs.Construct scope, string id, aws.Elasticache.IDataAwsElasticacheClusterConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        = GetStaticProperty<string>(typeof(aws.Elasticache.DataAwsElasticacheCluster))!;
        ...
        [JsiiProperty(name: "cacheNodes", typeJson: "{\"fqn\":\"aws.elasticache.DataAwsElasticacheClusterCacheNodesList\"}")]
        public virtual aws.Elasticache.DataAwsElasticacheClusterCacheNodesList CacheNodes
        {
            get => GetInstanceProperty<aws.Elasticache.DataAwsElasticacheClusterCacheNodesList>()!;
        }
