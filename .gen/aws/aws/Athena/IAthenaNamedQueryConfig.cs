...
namespace aws.Athena
{
    ...
    [JsiiInterface(nativeType: typeof(IAthenaNamedQueryConfig), fullyQualifiedName: "aws.athena.AthenaNamedQueryConfig")]
    public interface IAthenaNamedQueryConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>Amazon Athena.</summary>
        [JsiiTypeProxy(nativeType: typeof(IAthenaNamedQueryConfig), fullyQualifiedName: "aws.athena.AthenaNamedQueryConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Athena.IAthenaNamedQueryConfig
        {
