...
namespace aws.Kinesis
{
    ...
    [JsiiByValue(fqn: "aws.kinesis.KinesisAnalyticsApplicationOutputsLambda")]
    public class KinesisAnalyticsApplicationOutputsLambda : aws.Kinesis.IKinesisAnalyticsApplicationOutputsLambda
    {
