...
{
    [JsiiInterface(nativeType: typeof(IKinesisFirehoseDeliveryStreamS3Configuration), fullyQualifiedName: "aws.kinesis.KinesisFirehoseDeliveryStreamS3Configuration")]
    public interface IKinesisFirehoseDeliveryStreamS3Configuration
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        aws.Kinesis.IKinesisFirehoseDeliveryStreamS3ConfigurationCloudwatchLoggingOptions? CloudwatchLoggingOptions
        {
            get
            {
                return null;
        ...
        [JsiiTypeProxy(nativeType: typeof(IKinesisFirehoseDeliveryStreamS3Configuration), fullyQualifiedName: "aws.kinesis.KinesisFirehoseDeliveryStreamS3Configuration")]
        internal sealed class _Proxy : DeputyBase, aws.Kinesis.IKinesisFirehoseDeliveryStreamS3Configuration
        {
