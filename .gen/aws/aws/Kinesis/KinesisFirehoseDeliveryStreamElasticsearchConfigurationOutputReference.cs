...
namespace aws.Kinesis
{
    ...
    public class KinesisFirehoseDeliveryStreamElasticsearchConfigurationOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public KinesisFirehoseDeliveryStreamElasticsearchConfigurationOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
