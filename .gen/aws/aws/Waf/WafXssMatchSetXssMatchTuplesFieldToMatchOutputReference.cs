...
namespace aws.Waf
{
    ...
    public class WafXssMatchSetXssMatchTuplesFieldToMatchOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public WafXssMatchSetXssMatchTuplesFieldToMatchOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
