...
namespace aws.Waf
{
    ...
    [JsiiInterface(nativeType: typeof(IWafGeoMatchSetConfig), fullyQualifiedName: "aws.waf.WafGeoMatchSetConfig")]
    public interface IWafGeoMatchSetConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS WAF.</summary>
        [JsiiTypeProxy(nativeType: typeof(IWafGeoMatchSetConfig), fullyQualifiedName: "aws.waf.WafGeoMatchSetConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Waf.IWafGeoMatchSetConfig
        {
