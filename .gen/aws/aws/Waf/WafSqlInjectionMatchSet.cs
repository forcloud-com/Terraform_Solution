...
namespace aws.Waf
{
    ...
    public class WafSqlInjectionMatchSet : HashiCorp.Cdktf.TerraformResource
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "sqlInjectionMatchTuplesInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.waf.WafSqlInjectionMatchSetSqlInjectionMatchTuples\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        public virtual object? SqlInjectionMatchTuplesInput
        {
        ...
        [JsiiProperty(name: "sqlInjectionMatchTuples", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.waf.WafSqlInjectionMatchSetSqlInjectionMatchTuples\"},\"kind\":\"array\"}}]}}")]
