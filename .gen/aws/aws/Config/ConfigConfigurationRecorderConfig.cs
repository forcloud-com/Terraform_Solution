...
namespace aws.Config
{
    ...
    [JsiiByValue(fqn: "aws.config.ConfigConfigurationRecorderConfig")]
    public class ConfigConfigurationRecorderConfig : aws.Config.IConfigConfigurationRecorderConfig
    {
