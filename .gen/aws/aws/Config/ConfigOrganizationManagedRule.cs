...
{
    /// <summary>Represents a {@link https://www.terraform.io/docs/providers/aws/r/config_organization_managed_rule aws_config_organization_managed_rule}.</summary>
    [JsiiClass(nativeType: typeof(aws.Config.ConfigOrganizationManagedRule), fullyQualifiedName: "aws.config.ConfigOrganizationManagedRule", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.config.ConfigOrganizationManagedRuleConfig\"}}]")]
    public class ConfigOrganizationManagedRule : HashiCorp.Cdktf.TerraformResource
    {
        /// <summary>Create a new {@link https://www.terraform.io/docs/providers/aws/r/config_organization_managed_rule aws_config_organization_managed_rule} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public ConfigOrganizationManagedRule(Constructs.Construct scope, string id, aws.Config.IConfigOrganizationManagedRuleConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiMethod(name: "putTimeouts", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.config.ConfigOrganizationManagedRuleTimeouts\"}}]")]
        public virtual void PutTimeouts(aws.Config.IConfigOrganizationManagedRuleTimeouts @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.Config.IConfigOrganizationManagedRuleTimeouts)}, new object[]{@value});
        }
        ...
        = GetStaticProperty<string>(typeof(aws.Config.ConfigOrganizationManagedRule))!;
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.config.ConfigOrganizationManagedRuleTimeoutsOutputReference\"}")]
        public virtual aws.Config.ConfigOrganizationManagedRuleTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<aws.Config.ConfigOrganizationManagedRuleTimeoutsOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"fqn\":\"aws.config.ConfigOrganizationManagedRuleTimeouts\"}", isOptional: true)]
        public virtual aws.Config.IConfigOrganizationManagedRuleTimeouts? TimeoutsInput
        {
