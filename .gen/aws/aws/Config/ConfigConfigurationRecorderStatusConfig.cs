...
namespace aws.Config
{
    ...
    [JsiiByValue(fqn: "aws.config.ConfigConfigurationRecorderStatusConfig")]
    public class ConfigConfigurationRecorderStatusConfig : aws.Config.IConfigConfigurationRecorderStatusConfig
    {
