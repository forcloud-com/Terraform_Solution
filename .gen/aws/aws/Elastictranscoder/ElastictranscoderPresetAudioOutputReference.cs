...
namespace aws.Elastictranscoder
{
    ...
    public class ElastictranscoderPresetAudioOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public ElastictranscoderPresetAudioOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
