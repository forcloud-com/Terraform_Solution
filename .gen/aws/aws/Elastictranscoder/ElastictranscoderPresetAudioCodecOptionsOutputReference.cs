...
namespace aws.Elastictranscoder
{
    ...
    public class ElastictranscoderPresetAudioCodecOptionsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public ElastictranscoderPresetAudioCodecOptionsOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
