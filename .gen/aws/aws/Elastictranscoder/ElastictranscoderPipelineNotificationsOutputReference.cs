...
namespace aws.Elastictranscoder
{
    ...
    public class ElastictranscoderPipelineNotificationsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public ElastictranscoderPipelineNotificationsOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
