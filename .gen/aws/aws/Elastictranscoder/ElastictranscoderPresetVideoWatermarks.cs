...
{
    [JsiiByValue(fqn: "aws.elastictranscoder.ElastictranscoderPresetVideoWatermarks")]
    public class ElastictranscoderPresetVideoWatermarks : aws.Elastictranscoder.IElastictranscoderPresetVideoWatermarks
    {
