...
namespace aws.Route53
{
    ...
    public class Route53ResolverEndpoint : HashiCorp.Cdktf.TerraformResource
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "ipAddressInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.route53.Route53ResolverEndpointIpAddress\"},\"kind\":\"array\"}}]}}", isOptional: true)]
