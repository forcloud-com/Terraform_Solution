...
namespace aws.Dynamodb
{
    ...
    public class DataAwsDynamodbTableServerSideEncryptionOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public DataAwsDynamodbTableServerSideEncryptionOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
