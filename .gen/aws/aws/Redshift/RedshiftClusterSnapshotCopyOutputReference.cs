...
namespace aws.Redshift
{
    ...
    public class RedshiftClusterSnapshotCopyOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public RedshiftClusterSnapshotCopyOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
