...
namespace aws.Redshift
{
    ...
    [JsiiInterface(nativeType: typeof(IRedshiftSnapshotScheduleAssociationConfig), fullyQualifiedName: "aws.redshift.RedshiftSnapshotScheduleAssociationConfig")]
    public interface IRedshiftSnapshotScheduleAssociationConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Redshift.</summary>
        [JsiiTypeProxy(nativeType: typeof(IRedshiftSnapshotScheduleAssociationConfig), fullyQualifiedName: "aws.redshift.RedshiftSnapshotScheduleAssociationConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Redshift.IRedshiftSnapshotScheduleAssociationConfig
        {
