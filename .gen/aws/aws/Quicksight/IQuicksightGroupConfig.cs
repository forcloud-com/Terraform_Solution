...
namespace aws.Quicksight
{
    ...
    [JsiiInterface(nativeType: typeof(IQuicksightGroupConfig), fullyQualifiedName: "aws.quicksight.QuicksightGroupConfig")]
    public interface IQuicksightGroupConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS QuickSight.</summary>
        [JsiiTypeProxy(nativeType: typeof(IQuicksightGroupConfig), fullyQualifiedName: "aws.quicksight.QuicksightGroupConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Quicksight.IQuicksightGroupConfig
        {
