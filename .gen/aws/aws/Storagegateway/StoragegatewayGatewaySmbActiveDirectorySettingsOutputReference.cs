...
namespace aws.Storagegateway
{
    ...
    public class StoragegatewayGatewaySmbActiveDirectorySettingsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public StoragegatewayGatewaySmbActiveDirectorySettingsOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
