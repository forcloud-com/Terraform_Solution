...
namespace aws.Storagegateway
{
    ...
    [JsiiByValue(fqn: "aws.storagegateway.StoragegatewayUploadBufferConfig")]
    public class StoragegatewayUploadBufferConfig : aws.Storagegateway.IStoragegatewayUploadBufferConfig
    {
