...
namespace aws.Appmesh
{
    ...
    public class AppmeshVirtualServiceSpecProviderVirtualRouterOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public AppmeshVirtualServiceSpecProviderVirtualRouterOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
