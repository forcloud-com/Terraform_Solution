...
namespace aws.Appmesh
{
    ...
    public class AppmeshRouteSpecHttpRouteMatchHeaderMatchOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public AppmeshRouteSpecHttpRouteMatchHeaderMatchOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
