...
namespace aws.Appmesh
{
    ...
    [JsiiByValue(fqn: "aws.appmesh.AppmeshRouteSpecHttpRouteActionWeightedTarget")]
    public class AppmeshRouteSpecHttpRouteActionWeightedTarget : aws.Appmesh.IAppmeshRouteSpecHttpRouteActionWeightedTarget
    {
