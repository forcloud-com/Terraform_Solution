...
namespace aws.Appmesh
{
    ...
    public class AppmeshRouteSpecHttpRouteMatchHeaderMatchRangeOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public AppmeshRouteSpecHttpRouteMatchHeaderMatchRangeOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
