...
namespace aws.Dax
{
    ...
    [JsiiInterface(nativeType: typeof(IDaxSubnetGroupConfig), fullyQualifiedName: "aws.dax.DaxSubnetGroupConfig")]
    public interface IDaxSubnetGroupConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS DynamoDB Accelerator.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDaxSubnetGroupConfig), fullyQualifiedName: "aws.dax.DaxSubnetGroupConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Dax.IDaxSubnetGroupConfig
        {
