...
namespace aws.Dax
{
    ...
    public class DaxParameterGroupConfig : aws.Dax.IDaxParameterGroupConfig
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "parameters", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.dax.DaxParameterGroupParameters\"},\"kind\":\"array\"}}]}}", isOptional: true)]
