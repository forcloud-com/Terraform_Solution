...
namespace aws.Efs
{
    [JsiiClass(nativeType: typeof(aws.Efs.DataAwsEfsAccessPointRootDirectoryCreationInfoOutputReference), fullyQualifiedName: "aws.efs.DataAwsEfsAccessPointRootDirectoryCreationInfoOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}},{\"docs\":{\"summary\":\"the index of this item in the list.\"},\"name\":\"complexObjectIndex\",\"type\":{\"primitive\":\"number\"}},{\"docs\":{\"summary\":\"whether the list is wrapping a set (will add tolist() to be able to access an item via an index).\"},\"name\":\"complexObjectIsFromSet\",\"type\":{\"primitive\":\"boolean\"}}]")]
    public class DataAwsEfsAccessPointRootDirectoryCreationInfoOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.efs.DataAwsEfsAccessPointRootDirectoryCreationInfo\"}", isOptional: true)]
        public virtual aws.Efs.IDataAwsEfsAccessPointRootDirectoryCreationInfo? InternalValue
        {
            get => GetInstanceProperty<aws.Efs.IDataAwsEfsAccessPointRootDirectoryCreationInfo?>();
