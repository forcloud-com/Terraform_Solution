...
namespace aws.Efs
{
    ...
    [JsiiClass(nativeType: typeof(aws.Efs.DataAwsEfsMountTarget), fullyQualifiedName: "aws.efs.DataAwsEfsMountTarget", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.efs.DataAwsEfsMountTargetConfig\"}}]")]
    public class DataAwsEfsMountTarget : HashiCorp.Cdktf.TerraformDataSource
    {
        ...
        public DataAwsEfsMountTarget(Constructs.Construct scope, string id, aws.Efs.IDataAwsEfsMountTargetConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
