...
namespace aws.Efs
{
    ...
    [JsiiInterface(nativeType: typeof(IEfsMountTargetConfig), fullyQualifiedName: "aws.efs.EfsMountTargetConfig")]
    public interface IEfsMountTargetConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS EFS.</summary>
        [JsiiTypeProxy(nativeType: typeof(IEfsMountTargetConfig), fullyQualifiedName: "aws.efs.EfsMountTargetConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Efs.IEfsMountTargetConfig
        {
