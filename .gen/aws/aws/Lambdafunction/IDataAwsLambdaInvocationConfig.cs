...
namespace aws.Lambdafunction
{
    ...
    [JsiiInterface(nativeType: typeof(IDataAwsLambdaInvocationConfig), fullyQualifiedName: "aws.lambdafunction.DataAwsLambdaInvocationConfig")]
    public interface IDataAwsLambdaInvocationConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Lambda.</summary>
        [JsiiTypeProxy(nativeType: typeof(IDataAwsLambdaInvocationConfig), fullyQualifiedName: "aws.lambdafunction.DataAwsLambdaInvocationConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Lambdafunction.IDataAwsLambdaInvocationConfig
        {
