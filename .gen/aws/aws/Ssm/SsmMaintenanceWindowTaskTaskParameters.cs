...
namespace aws.Ssm
{
    ...
    [JsiiByValue(fqn: "aws.ssm.SsmMaintenanceWindowTaskTaskParameters")]
    public class SsmMaintenanceWindowTaskTaskParameters : aws.Ssm.ISsmMaintenanceWindowTaskTaskParameters
    {
