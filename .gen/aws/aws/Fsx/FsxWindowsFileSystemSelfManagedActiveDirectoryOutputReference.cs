...
namespace aws.Fsx
{
    [JsiiClass(nativeType: typeof(aws.Fsx.FsxWindowsFileSystemSelfManagedActiveDirectoryOutputReference), fullyQualifiedName: "aws.fsx.FsxWindowsFileSystemSelfManagedActiveDirectoryOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class FsxWindowsFileSystemSelfManagedActiveDirectoryOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public FsxWindowsFileSystemSelfManagedActiveDirectoryOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.fsx.FsxWindowsFileSystemSelfManagedActiveDirectory\"}", isOptional: true)]
        public virtual aws.Fsx.IFsxWindowsFileSystemSelfManagedActiveDirectory? InternalValue
        {
