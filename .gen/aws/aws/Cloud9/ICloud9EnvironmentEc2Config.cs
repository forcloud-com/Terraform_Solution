...
namespace aws.Cloud9
{
    ...
    [JsiiInterface(nativeType: typeof(ICloud9EnvironmentEc2Config), fullyQualifiedName: "aws.cloud9.Cloud9EnvironmentEc2Config")]
    public interface ICloud9EnvironmentEc2Config : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Cloud9.</summary>
        [JsiiTypeProxy(nativeType: typeof(ICloud9EnvironmentEc2Config), fullyQualifiedName: "aws.cloud9.Cloud9EnvironmentEc2Config")]
        internal sealed class _Proxy : DeputyBase, aws.Cloud9.ICloud9EnvironmentEc2Config
        {
