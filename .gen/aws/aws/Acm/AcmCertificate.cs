...
namespace aws.Acm
{
    ...
    public class AcmCertificate : HashiCorp.Cdktf.TerraformResource
    {
        ...
        [JsiiProperty(name: "domainValidationOptions", typeJson: "{\"fqn\":\"aws.acm.AcmCertificateDomainValidationOptionsList\"}")]
        public virtual aws.Acm.AcmCertificateDomainValidationOptionsList DomainValidationOptions
        {
            get => GetInstanceProperty<aws.Acm.AcmCertificateDomainValidationOptionsList>()!;
        }
