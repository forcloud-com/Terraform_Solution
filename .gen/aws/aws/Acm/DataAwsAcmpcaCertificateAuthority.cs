...
namespace aws.Acm
{
    ...
    public class DataAwsAcmpcaCertificateAuthority : HashiCorp.Cdktf.TerraformDataSource
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "revocationConfigurationInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.acm.DataAwsAcmpcaCertificateAuthorityRevocationConfiguration\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        public virtual object? RevocationConfigurationInput
        {
        ...
        [JsiiProperty(name: "revocationConfiguration", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.acm.DataAwsAcmpcaCertificateAuthorityRevocationConfiguration\"},\"kind\":\"array\"}}]}}")]
        public virtual object RevocationConfiguration
        {
            get => GetInstanceProperty<object>()!;
            set => SetInstanceProperty(value);
        }
