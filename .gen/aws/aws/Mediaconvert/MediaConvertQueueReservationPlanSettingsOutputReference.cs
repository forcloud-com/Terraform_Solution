...
namespace aws.Mediaconvert
{
    ...
    public class MediaConvertQueueReservationPlanSettingsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public MediaConvertQueueReservationPlanSettingsOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
