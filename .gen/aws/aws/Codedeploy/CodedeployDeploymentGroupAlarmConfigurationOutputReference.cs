...
namespace aws.Codedeploy
{
    ...
    public class CodedeployDeploymentGroupAlarmConfigurationOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public CodedeployDeploymentGroupAlarmConfigurationOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
