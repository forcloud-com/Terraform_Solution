...
{
    [JsiiClass(nativeType: typeof(aws.Codedeploy.CodedeployDeploymentGroupDeploymentStyleOutputReference), fullyQualifiedName: "aws.codedeploy.CodedeployDeploymentGroupDeploymentStyleOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class CodedeployDeploymentGroupDeploymentStyleOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public CodedeployDeploymentGroupDeploymentStyleOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "internalValue", typeJson: "{\"fqn\":\"aws.codedeploy.CodedeployDeploymentGroupDeploymentStyle\"}", isOptional: true)]
        public virtual aws.Codedeploy.ICodedeployDeploymentGroupDeploymentStyle? InternalValue
        {
