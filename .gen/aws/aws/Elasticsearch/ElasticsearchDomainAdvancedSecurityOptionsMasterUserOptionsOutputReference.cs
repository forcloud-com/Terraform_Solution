...
namespace aws.Elasticsearch
{
    ...
    public class ElasticsearchDomainAdvancedSecurityOptionsMasterUserOptionsOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public ElasticsearchDomainAdvancedSecurityOptionsMasterUserOptionsOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
