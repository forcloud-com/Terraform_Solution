...
namespace aws.Elasticsearch
{
    ...
    public class ElasticsearchDomainClusterConfigZoneAwarenessConfigOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public ElasticsearchDomainClusterConfigZoneAwarenessConfigOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
