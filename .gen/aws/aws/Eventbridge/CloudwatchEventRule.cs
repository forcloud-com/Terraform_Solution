...
{
    /// <summary>Represents a {@link https://www.terraform.io/docs/providers/aws/r/cloudwatch_event_rule aws_cloudwatch_event_rule}.</summary>
    [JsiiClass(nativeType: typeof(aws.Eventbridge.CloudwatchEventRule), fullyQualifiedName: "aws.eventbridge.CloudwatchEventRule", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"optional\":true,\"type\":{\"fqn\":\"aws.eventbridge.CloudwatchEventRuleConfig\"}}]")]
    public class CloudwatchEventRule : HashiCorp.Cdktf.TerraformResource
    {
        /// <summary>Create a new {@link https://www.terraform.io/docs/providers/aws/r/cloudwatch_event_rule aws_cloudwatch_event_rule} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public CloudwatchEventRule(Constructs.Construct scope, string id, aws.Eventbridge.ICloudwatchEventRuleConfig? config = null): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        protected CloudwatchEventRule(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected CloudwatchEventRule(DeputyProps props): base(props)
        {
        }
        ...
        = GetStaticProperty<string>(typeof(aws.Eventbridge.CloudwatchEventRule))!;
