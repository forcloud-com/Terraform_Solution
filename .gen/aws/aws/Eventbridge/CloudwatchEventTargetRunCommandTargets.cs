...
namespace aws.Eventbridge
{
    ...
    [JsiiByValue(fqn: "aws.eventbridge.CloudwatchEventTargetRunCommandTargets")]
    public class CloudwatchEventTargetRunCommandTargets : aws.Eventbridge.ICloudwatchEventTargetRunCommandTargets
    {
