...
namespace aws.Eventbridge
{
    ...
    public class CloudwatchEventTargetInputTransformerOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public CloudwatchEventTargetInputTransformerOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
