...
namespace aws.Eventbridge
{
    ...
    [JsiiInterface(nativeType: typeof(ICloudwatchEventRuleConfig), fullyQualifiedName: "aws.eventbridge.CloudwatchEventRuleConfig")]
    public interface ICloudwatchEventRuleConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS CloudWatch Event Bridge.</summary>
        [JsiiTypeProxy(nativeType: typeof(ICloudwatchEventRuleConfig), fullyQualifiedName: "aws.eventbridge.CloudwatchEventRuleConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Eventbridge.ICloudwatchEventRuleConfig
        {
