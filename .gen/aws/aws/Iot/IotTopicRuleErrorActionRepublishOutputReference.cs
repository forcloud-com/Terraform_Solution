...
namespace aws.Iot
{
    ...
    public class IotTopicRuleErrorActionRepublishOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public IotTopicRuleErrorActionRepublishOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
