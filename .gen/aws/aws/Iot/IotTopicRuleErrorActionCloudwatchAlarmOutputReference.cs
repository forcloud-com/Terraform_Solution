...
namespace aws.Iot
{
    ...
    public class IotTopicRuleErrorActionCloudwatchAlarmOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public IotTopicRuleErrorActionCloudwatchAlarmOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
