...
namespace aws.Iot
{
    ...
    public class IotThingTypePropertiesOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public IotThingTypePropertiesOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
