...
{
    [JsiiByValue(fqn: "aws.apigatewayv2.Apigatewayv2StageDefaultRouteSettings")]
    public class Apigatewayv2StageDefaultRouteSettings : aws.Apigatewayv2.IApigatewayv2StageDefaultRouteSettings
    {
