...
namespace aws.Apigatewayv2
{
    ...
    [JsiiInterface(nativeType: typeof(IApigatewayv2DeploymentConfig), fullyQualifiedName: "aws.apigatewayv2.Apigatewayv2DeploymentConfig")]
    public interface IApigatewayv2DeploymentConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>Amazon API Gateway Websocket and HTTP APIs.</summary>
        [JsiiTypeProxy(nativeType: typeof(IApigatewayv2DeploymentConfig), fullyQualifiedName: "aws.apigatewayv2.Apigatewayv2DeploymentConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Apigatewayv2.IApigatewayv2DeploymentConfig
        {
