...
namespace aws.Securityhub
{
    ...
    [JsiiByValue(fqn: "aws.securityhub.SecurityhubStandardsSubscriptionConfig")]
    public class SecurityhubStandardsSubscriptionConfig : aws.Securityhub.ISecurityhubStandardsSubscriptionConfig
    {
