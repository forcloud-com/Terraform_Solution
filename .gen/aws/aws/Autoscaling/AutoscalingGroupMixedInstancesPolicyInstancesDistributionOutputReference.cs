...
{
    [JsiiClass(nativeType: typeof(aws.Autoscaling.AutoscalingGroupMixedInstancesPolicyInstancesDistributionOutputReference), fullyQualifiedName: "aws.autoscaling.AutoscalingGroupMixedInstancesPolicyInstancesDistributionOutputReference", parametersJson: "[{\"docs\":{\"summary\":\"The parent resource.\"},\"name\":\"terraformResource\",\"type\":{\"fqn\":\"cdktf.IInterpolatingParent\"}},{\"docs\":{\"summary\":\"The attribute on the parent resource this class is referencing.\"},\"name\":\"terraformAttribute\",\"type\":{\"primitive\":\"string\"}}]")]
    public class AutoscalingGroupMixedInstancesPolicyInstancesDistributionOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public AutoscalingGroupMixedInstancesPolicyInstancesDistributionOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
