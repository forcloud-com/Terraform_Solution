...
namespace aws.Lightsail
{
    ...
    [JsiiInterface(nativeType: typeof(ILightsailInstanceConfig), fullyQualifiedName: "aws.lightsail.LightsailInstanceConfig")]
    public interface ILightsailInstanceConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Lightsail.</summary>
        [JsiiTypeProxy(nativeType: typeof(ILightsailInstanceConfig), fullyQualifiedName: "aws.lightsail.LightsailInstanceConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Lightsail.ILightsailInstanceConfig
        {
