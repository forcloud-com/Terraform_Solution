...
namespace aws.Budgets
{
    ...
    public class BudgetsBudgetCostTypesOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public BudgetsBudgetCostTypesOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
