...
{
    /// <summary>Represents a {@link https://www.terraform.io/docs/providers/aws/r/neptune_cluster aws_neptune_cluster}.</summary>
    [JsiiClass(nativeType: typeof(aws.Neptune.NeptuneCluster), fullyQualifiedName: "aws.neptune.NeptuneCluster", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"optional\":true,\"type\":{\"fqn\":\"aws.neptune.NeptuneClusterConfig\"}}]")]
    public class NeptuneCluster : HashiCorp.Cdktf.TerraformResource
    {
        /// <summary>Create a new {@link https://www.terraform.io/docs/providers/aws/r/neptune_cluster aws_neptune_cluster} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public NeptuneCluster(Constructs.Construct scope, string id, aws.Neptune.INeptuneClusterConfig? config = null): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiMethod(name: "putTimeouts", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.neptune.NeptuneClusterTimeouts\"}}]")]
        public virtual void PutTimeouts(aws.Neptune.INeptuneClusterTimeouts @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.Neptune.INeptuneClusterTimeouts)}, new object[]{@value});
        }
        ...
        = GetStaticProperty<string>(typeof(aws.Neptune.NeptuneCluster))!;
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.neptune.NeptuneClusterTimeoutsOutputReference\"}")]
        public virtual aws.Neptune.NeptuneClusterTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<aws.Neptune.NeptuneClusterTimeoutsOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"fqn\":\"aws.neptune.NeptuneClusterTimeouts\"}", isOptional: true)]
        public virtual aws.Neptune.INeptuneClusterTimeouts? TimeoutsInput
        {
