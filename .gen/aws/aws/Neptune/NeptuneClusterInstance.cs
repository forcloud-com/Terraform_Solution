...
{
    /// <summary>Represents a {@link https://www.terraform.io/docs/providers/aws/r/neptune_cluster_instance aws_neptune_cluster_instance}.</summary>
    [JsiiClass(nativeType: typeof(aws.Neptune.NeptuneClusterInstance), fullyQualifiedName: "aws.neptune.NeptuneClusterInstance", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.neptune.NeptuneClusterInstanceConfig\"}}]")]
    public class NeptuneClusterInstance : HashiCorp.Cdktf.TerraformResource
    {
        /// <summary>Create a new {@link https://www.terraform.io/docs/providers/aws/r/neptune_cluster_instance aws_neptune_cluster_instance} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public NeptuneClusterInstance(Constructs.Construct scope, string id, aws.Neptune.INeptuneClusterInstanceConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        [JsiiMethod(name: "putTimeouts", parametersJson: "[{\"name\":\"value\",\"type\":{\"fqn\":\"aws.neptune.NeptuneClusterInstanceTimeouts\"}}]")]
        public virtual void PutTimeouts(aws.Neptune.INeptuneClusterInstanceTimeouts @value)
        {
            InvokeInstanceVoidMethod(new System.Type[]{typeof(aws.Neptune.INeptuneClusterInstanceTimeouts)}, new object[]{@value});
        }
        ...
        = GetStaticProperty<string>(typeof(aws.Neptune.NeptuneClusterInstance))!;
        ...
        [JsiiProperty(name: "timeouts", typeJson: "{\"fqn\":\"aws.neptune.NeptuneClusterInstanceTimeoutsOutputReference\"}")]
        public virtual aws.Neptune.NeptuneClusterInstanceTimeoutsOutputReference Timeouts
        {
            get => GetInstanceProperty<aws.Neptune.NeptuneClusterInstanceTimeoutsOutputReference>()!;
        }
        ...
        [JsiiOptional]
        [JsiiProperty(name: "timeoutsInput", typeJson: "{\"fqn\":\"aws.neptune.NeptuneClusterInstanceTimeouts\"}", isOptional: true)]
        public virtual aws.Neptune.INeptuneClusterInstanceTimeouts? TimeoutsInput
        {
            get => GetInstanceProperty<aws.Neptune.INeptuneClusterInstanceTimeouts?>();
        }
