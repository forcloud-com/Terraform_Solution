...
namespace aws.Pinpoint
{
    ...
    [JsiiInterface(nativeType: typeof(IPinpointBaiduChannelConfig), fullyQualifiedName: "aws.pinpoint.PinpointBaiduChannelConfig")]
    public interface IPinpointBaiduChannelConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Pinpoint.</summary>
        [JsiiTypeProxy(nativeType: typeof(IPinpointBaiduChannelConfig), fullyQualifiedName: "aws.pinpoint.PinpointBaiduChannelConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Pinpoint.IPinpointBaiduChannelConfig
        {
