...
namespace aws.Pinpoint
{
    ...
    [JsiiInterface(nativeType: typeof(IPinpointEmailChannelConfig), fullyQualifiedName: "aws.pinpoint.PinpointEmailChannelConfig")]
    public interface IPinpointEmailChannelConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Pinpoint.</summary>
        [JsiiTypeProxy(nativeType: typeof(IPinpointEmailChannelConfig), fullyQualifiedName: "aws.pinpoint.PinpointEmailChannelConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Pinpoint.IPinpointEmailChannelConfig
        {
