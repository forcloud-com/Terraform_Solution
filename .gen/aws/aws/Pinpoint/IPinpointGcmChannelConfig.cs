...
namespace aws.Pinpoint
{
    ...
    [JsiiInterface(nativeType: typeof(IPinpointGcmChannelConfig), fullyQualifiedName: "aws.pinpoint.PinpointGcmChannelConfig")]
    public interface IPinpointGcmChannelConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Pinpoint.</summary>
        [JsiiTypeProxy(nativeType: typeof(IPinpointGcmChannelConfig), fullyQualifiedName: "aws.pinpoint.PinpointGcmChannelConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Pinpoint.IPinpointGcmChannelConfig
        {
