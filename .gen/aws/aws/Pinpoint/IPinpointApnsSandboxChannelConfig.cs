...
namespace aws.Pinpoint
{
    ...
    [JsiiInterface(nativeType: typeof(IPinpointApnsSandboxChannelConfig), fullyQualifiedName: "aws.pinpoint.PinpointApnsSandboxChannelConfig")]
    public interface IPinpointApnsSandboxChannelConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Pinpoint.</summary>
        [JsiiTypeProxy(nativeType: typeof(IPinpointApnsSandboxChannelConfig), fullyQualifiedName: "aws.pinpoint.PinpointApnsSandboxChannelConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Pinpoint.IPinpointApnsSandboxChannelConfig
        {
