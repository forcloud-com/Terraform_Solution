...
{
    /// <summary>Represents a {@link https://www.terraform.io/docs/providers/aws/r/pinpoint_apns_voip_channel aws_pinpoint_apns_voip_channel}.</summary>
    [JsiiClass(nativeType: typeof(aws.Pinpoint.PinpointApnsVoipChannel), fullyQualifiedName: "aws.pinpoint.PinpointApnsVoipChannel", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.pinpoint.PinpointApnsVoipChannelConfig\"}}]")]
    public class PinpointApnsVoipChannel : HashiCorp.Cdktf.TerraformResource
    {
        /// <summary>Create a new {@link https://www.terraform.io/docs/providers/aws/r/pinpoint_apns_voip_channel aws_pinpoint_apns_voip_channel} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public PinpointApnsVoipChannel(Constructs.Construct scope, string id, aws.Pinpoint.IPinpointApnsVoipChannelConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        protected PinpointApnsVoipChannel(ByRefValue reference): base(reference)
        {
        }
        ...
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        protected PinpointApnsVoipChannel(DeputyProps props): base(props)
        {
        }
        ...
        = GetStaticProperty<string>(typeof(aws.Pinpoint.PinpointApnsVoipChannel))!;
