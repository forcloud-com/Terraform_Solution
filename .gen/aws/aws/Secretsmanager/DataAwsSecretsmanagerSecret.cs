...
namespace aws.Secretsmanager
{
    ...
    public class DataAwsSecretsmanagerSecret : HashiCorp.Cdktf.TerraformDataSource
    {
        ...
        [JsiiProperty(name: "rotationRules", typeJson: "{\"fqn\":\"aws.secretsmanager.DataAwsSecretsmanagerSecretRotationRulesList\"}")]
        public virtual aws.Secretsmanager.DataAwsSecretsmanagerSecretRotationRulesList RotationRules
        {
            get => GetInstanceProperty<aws.Secretsmanager.DataAwsSecretsmanagerSecretRotationRulesList>()!;
        }
