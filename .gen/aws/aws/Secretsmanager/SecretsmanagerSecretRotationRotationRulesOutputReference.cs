...
namespace aws.Secretsmanager
{
    ...
    public class SecretsmanagerSecretRotationRotationRulesOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public SecretsmanagerSecretRotationRotationRulesOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
