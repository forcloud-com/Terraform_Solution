...
namespace aws.Sagemaker
{
    ...
    public class SagemakerModelPrimaryContainerOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public SagemakerModelPrimaryContainerOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
