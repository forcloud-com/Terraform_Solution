...
namespace aws.Sagemaker
{
    ...
    [JsiiByValue(fqn: "aws.sagemaker.SagemakerNotebookInstanceConfig")]
    public class SagemakerNotebookInstanceConfig : aws.Sagemaker.ISagemakerNotebookInstanceConfig
    {
