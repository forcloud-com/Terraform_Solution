...
namespace aws.Sagemaker
{
    ...
    public class SagemakerEndpointConfiguration : HashiCorp.Cdktf.TerraformResource
    {
        ...
        [JsiiOptional]
        [JsiiProperty(name: "productionVariantsInput", typeJson: "{\"union\":{\"types\":[{\"fqn\":\"cdktf.IResolvable\"},{\"collection\":{\"elementtype\":{\"fqn\":\"aws.sagemaker.SagemakerEndpointConfigurationProductionVariants\"},\"kind\":\"array\"}}]}}", isOptional: true)]
        ...
        public virtual object ProductionVariants
        {
            get => GetInstanceProperty<object>()!;
            set => SetInstanceProperty(value);
        }
