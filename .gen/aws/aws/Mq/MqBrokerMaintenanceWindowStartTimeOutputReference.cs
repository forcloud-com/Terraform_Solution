...
namespace aws.Mq
{
    ...
    public class MqBrokerMaintenanceWindowStartTimeOutputReference : HashiCorp.Cdktf.ComplexObject
    {
        ...
        public MqBrokerMaintenanceWindowStartTimeOutputReference(HashiCorp.Cdktf.IInterpolatingParent terraformResource, string terraformAttribute): base(new DeputyProps(new object?[]{terraformResource, terraformAttribute}))
        {
        }
