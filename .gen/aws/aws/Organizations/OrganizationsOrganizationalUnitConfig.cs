...
namespace aws.Organizations
{
    ...
    [JsiiByValue(fqn: "aws.organizations.OrganizationsOrganizationalUnitConfig")]
    public class OrganizationsOrganizationalUnitConfig : aws.Organizations.IOrganizationsOrganizationalUnitConfig
    {
