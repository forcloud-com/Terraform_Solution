...
{
    /// <summary>Represents a {@link https://www.terraform.io/docs/providers/aws/r/organizations_account aws_organizations_account}.</summary>
    [JsiiClass(nativeType: typeof(aws.Organizations.OrganizationsAccount), fullyQualifiedName: "aws.organizations.OrganizationsAccount", parametersJson: "[{\"docs\":{\"summary\":\"The scope in which to define this construct.\"},\"name\":\"scope\",\"type\":{\"fqn\":\"constructs.Construct\"}},{\"docs\":{\"remarks\":\"Must be unique amongst siblings in the same scope\",\"summary\":\"The scoped construct ID.\"},\"name\":\"id\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"config\",\"type\":{\"fqn\":\"aws.organizations.OrganizationsAccountConfig\"}}]")]
    public class OrganizationsAccount : HashiCorp.Cdktf.TerraformResource
    {
        /// <summary>Create a new {@link https://www.terraform.io/docs/providers/aws/r/organizations_account aws_organizations_account} Resource.</summary>
        /// <param name="scope">The scope in which to define this construct.</param>
        /// <param name="id">The scoped construct ID.</param>
        public OrganizationsAccount(Constructs.Construct scope, string id, aws.Organizations.IOrganizationsAccountConfig config): base(new DeputyProps(new object?[]{scope, id, config}))
        {
        }
        ...
        = GetStaticProperty<string>(typeof(aws.Organizations.OrganizationsAccount))!;
