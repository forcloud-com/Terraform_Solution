...
namespace aws.Organizations
{
    ...
    public class DataAwsOrganizationsOrganizationalUnits : HashiCorp.Cdktf.TerraformDataSource
    {
        ...
        [JsiiProperty(name: "children", typeJson: "{\"fqn\":\"aws.organizations.DataAwsOrganizationsOrganizationalUnitsChildrenList\"}")]
        public virtual aws.Organizations.DataAwsOrganizationsOrganizationalUnitsChildrenList Children
        {
            get => GetInstanceProperty<aws.Organizations.DataAwsOrganizationsOrganizationalUnitsChildrenList>()!;
        }
