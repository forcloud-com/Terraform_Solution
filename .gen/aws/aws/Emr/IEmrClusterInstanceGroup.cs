...
namespace aws.Emr
{
    [JsiiInterface(nativeType: typeof(IEmrClusterInstanceGroup), fullyQualifiedName: "aws.emr.EmrClusterInstanceGroup")]
    public interface IEmrClusterInstanceGroup
    {
        ...
        [JsiiTypeProxy(nativeType: typeof(IEmrClusterInstanceGroup), fullyQualifiedName: "aws.emr.EmrClusterInstanceGroup")]
        internal sealed class _Proxy : DeputyBase, aws.Emr.IEmrClusterInstanceGroup
        {
