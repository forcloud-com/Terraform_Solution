...
namespace aws.Emr
{
    ...
    [JsiiInterface(nativeType: typeof(IEmrSecurityConfigurationConfig), fullyQualifiedName: "aws.emr.EmrSecurityConfigurationConfig")]
    public interface IEmrSecurityConfigurationConfig : HashiCorp.Cdktf.ITerraformMetaArguments
    {
        ...
        /// <summary>AWS Elastic MapReduce.</summary>
        [JsiiTypeProxy(nativeType: typeof(IEmrSecurityConfigurationConfig), fullyQualifiedName: "aws.emr.EmrSecurityConfigurationConfig")]
        internal sealed class _Proxy : DeputyBase, aws.Emr.IEmrSecurityConfigurationConfig
        {
